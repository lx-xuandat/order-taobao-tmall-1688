...
<body>
                                ...
                                <div class="card custom-card nft-banner-card overflow-hidden">
                                    <div class="card-body p-5">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-5">
                                                <img src="/storage/assets/images/nft-images/1.png" class="img-fluid nft-main-banner-image d-lg-block d-none" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                                ...
                                <div class="card custom-card">
                                    <div class="card-body">
                                        <div class="position-relative mb-3 overflow-hidden rounded">
                                            <img src="/storage/assets/images/nft-images/3.jpg" class="card-img rounded" alt="...">
                                                    ...
                                                    <div class="text-end">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <span class="avatar avatar-xs">
                                                                <img src="/storage/assets/images/crypto-currencies/square-color/Ethereum.svg" alt="">
                                                            </span>
                            ...
                            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="card custom-card">
                                    <div class="card-body">
                                        <div class="position-relative mb-3 overflow-hidden rounded">
                                            <img src="/storage/assets/images/nft-images/4.jpg" class="card-img rounded" alt="...">
                                            <p class="mb-0 bg-secondary text-fixed-white nft-auction-time"> 04hrs : 24m : 38s </p>
                                            <div class="nft-content">
                            ...
                            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="card custom-card">
                                    <div class="card-body">
                                        <div class="position-relative mb-3 overflow-hidden rounded">
                                            <img src="/storage/assets/images/nft-images/5.jpg" class="card-img rounded" alt="...">
                                            <p class="mb-0 bg-secondary text-fixed-white nft-auction-time"> 04hrs : 24m : 38s </p>
                                            <div class="nft-content">
                            ...
                            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="card custom-card">
                                    <div class="card-body">
                                        <div class="position-relative mb-3 overflow-hidden rounded">
                                            <img src="/storage/assets/images/nft-images/2.jpg" class="card-img rounded" alt="...">
                                            <p class="mb-0 bg-secondary text-fixed-white nft-auction-time"> 04hrs : 24m : 38s </p>
                                            <div class="nft-content">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card custom-card">
                                                ...
                                                <div class="card-body">
                                                    <div class="row g-2">
                                                        <div class="col-6">
                                                            <img src="/storage/assets/images/nft-images/06.jpg" alt="" class="nft-featuredcollect-image">
                                                        </div>
                                                        <div class="col-6">
                                                            <img src="/storage/assets/images/nft-images/07.jpg" alt="" class="nft-featuredcollect-image">
                                                        </div>
                                                        <div class="col-6">
                                                            <img src="/storage/assets/images/nft-images/08.jpg" alt="" class="nft-featuredcollect-image">
                                                        </div>
                                                        <div class="col-6">
                                                            <img src="/storage/assets/images/nft-images/09.jpg" alt="" class="nft-featuredcollect-image">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card custom-card">
                                                ...
                                                <div class="card-body">
                                                    <div class="row g-2">
                                                        <div class="col-6">
                                                            <img src="/storage/assets/images/nft-images/11.jpg" alt="" class="nft-featuredcollect-image">
                                                        </div>
                                                        <div class="col-6">
                                                            <img src="/storage/assets/images/nft-images/12.jpg" alt="" class="nft-featuredcollect-image">
                                                        </div>
                                                        <div class="col-6">
                                                            <img src="/storage/assets/images/nft-images/13.jpg" alt="" class="nft-featuredcollect-image">
                                                        </div>
                                                        <div class="col-6">
                                                            <img src="/storage/assets/images/nft-images/14.jpg" alt="" class="nft-featuredcollect-image">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card custom-card">
                                                ...
                                                <div class="card-body">
                                                    <div class="row g-2">
                                                        <div class="col-6">
                                                            <img src="/storage/assets/images/nft-images/10.jpg" alt="" class="nft-featuredcollect-image">
                                                        </div>
                                                        <div class="col-6">
                                                            <img src="/storage/assets/images/nft-images/15.jpg" alt="" class="nft-featuredcollect-image">
                                                        </div>
                                                        <div class="col-6">
                                                            <img src="/storage/assets/images/nft-images/17.jpg" alt="" class="nft-featuredcollect-image">
                                                        </div>
                                                        <div class="col-6">
                                                            <img src="/storage/assets/images/nft-images/16.jpg" alt="" class="nft-featuredcollect-image">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="me-2 lh-1">
                                                                    <span class="avatar avatar-md avatar-rounded">
                                                                        <img src="/storage/assets/images/nft-images/09.jpg" alt="">
                                                                    </span>
                                                                </div>
                                                                <div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="me-2 lh-1">
                                                                    <span class="avatar avatar-md avatar-rounded">
                                                                        <img src="/storage/assets/images/nft-images/10.jpg" alt="">
                                                                    </span>
                                                                </div>
                                                                <div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="me-2 lh-1">
                                                                    <span class="avatar avatar-md avatar-rounded">
                                                                        <img src="/storage/assets/images/nft-images/11.jpg" alt="">
                                                                    </span>
                                                                </div>
                                                                <div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="me-2 lh-1">
                                                                    <span class="avatar avatar-md avatar-rounded">
                                                                        <img src="/storage/assets/images/nft-images/12.jpg" alt="">
                                                                    </span>
                                                                </div>
                                                                <div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="me-2 lh-1">
                                                                    <span class="avatar avatar-md avatar-rounded">
                                                                        <img src="/storage/assets/images/nft-images/13.jpg" alt="">
                                                                    </span>
                                                                </div>
                                                                <div>
                                                                    <p class="mb-0 fw-semibold"><a href="javascript:void(0);" title="nft_name">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2 lh-1">
                                                                <span class="avatar avatar-md">
                                                                    <img src="/storage/assets/images/nft-images/02.jpg" alt="">
                                                                </span>
                                                            </div>
                                                            <div>
                                                ...
                                                <a href="javascript:void(0);">
                                                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2 lh-1">
                                                                <span class="avatar avatar-md">
                                                                    <img src="/storage/assets/images/nft-images/03.jpg" alt="">
                                                                </span>
                                                            </div>
                                                            <div>
                                                ...
                                                <a href="javascript:void(0);">
                                                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2 lh-1">
                                                                <span class="avatar avatar-md">
                                                                    <img src="/storage/assets/images/nft-images/04.jpg" alt="">
                                                                </span>
                                                            </div>
                                                            <div>
                                                ...
                                                <a href="javascript:void(0);">
                                                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2 lh-1">
                                                                <span class="avatar avatar-md">
                                                                    <img src="/storage/assets/images/nft-images/05.jpg" alt="">
                                                                </span>
                                                            </div>
                                                            <div>
                                                ...
                                                <a href="javascript:void(0);">
                                                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2 lh-1">
                                                                <span class="avatar avatar-md">
                                                                    <img src="/storage/assets/images/nft-images/06.jpg" alt="">
                                                                </span>
                                                            </div>
                                                            <div>
                                                ...
                                                <a href="javascript:void(0);">
                                                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2 lh-1">
                                                                <span class="avatar avatar-md">
                                                                    <img src="/storage/assets/images/nft-images/07.jpg" alt="">
                                                                </span>
                                                            </div>
                                                            <div>
                                                ...
                                                <a href="javascript:void(0);">
                                                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2 lh-1">
                                                                <span class="avatar avatar-md">
                                                                    <img src="/storage/assets/images/nft-images/08.jpg" alt="">
                                                                </span>
                                                            </div>
                                                            <div>
                                                ...
                                                <a href="javascript:void(0);">
                                                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2 lh-1">
                                                                <span class="avatar avatar-md">
                                                                    <img src="/storage/assets/images/nft-images/14.jpg" alt="">
                                                                </span>
                                                            </div>
                                                            <div>
                                                        ...
                                                        <div class="text-end">
                                                            ...
                                                            <p class="mb-0 fw-medium d-flex align-items-center"><span class="avatar avatar-xs p-1"><img src="/storage/assets/images/crypto-currencies/regular/Bitcoin.svg" alt=""></span>1.75ETH</p>
                                                        </div>
                                                    </div>
                                                </a>
                                            </li>
                                                ...
                                                <a href="javascript:void(0);">
                                                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2 lh-1">
                                                                <span class="avatar avatar-md">
                                                                    <img src="/storage/assets/images/nft-images/15.jpg" alt="">
                                                                </span>
                                                            </div>
                                                            <div>
                                                        ...
                                                        <div class="text-end">
                                                            <span class="fs-10 text-muted ps-4">PRICE</span>
                                                            <p class="mb-0 fw-medium d-flex align-items-center"><span class="avatar avatar-xs p-1"><img src="/storage/assets/images/crypto-currencies/regular/Bitcoin.svg" alt=""></span>1.15ETH</p>
                                                        </div>
                                                    </div>
                                                </a>
                                            </li>
                                                ...
                                                <a href="javascript:void(0);">
                                                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2 lh-1">
                                                                <span class="avatar avatar-md">
                                                                    <img src="/storage/assets/images/nft-images/16.jpg" alt="">
                                                                </span>
                                                            </div>
                                                            <div>
                                                        ...
                                                        <div class="text-end">
                                                            <span class="fs-10 text-muted ps-4">PRICE</span>
                                                            <p class="mb-0 fw-medium d-flex align-items-center"><span class="avatar avatar-xs p-1"><img src="/storage/assets/images/crypto-currencies/regular/Bitcoin.svg" alt=""></span>1.58ETH</p>
                                                        </div>
                                                    </div>
                                                </a>
                                            </li>
                                                ...
                                                <a href="javascript:void(0);">
                                                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2 lh-1">
                                                                <span class="avatar avatar-md">
                                                                    <img src="/storage/assets/images/nft-images/19.jpg" alt="">
                                                                </span>
                                                            </div>
                                                            <div>
                                                        ...
                                                        <div class="text-end">
                                                            <span class="fs-10 text-muted ps-4">PRICE</span>
                                                            <p class="mb-0 fw-medium d-flex align-items-center"><span class="avatar avatar-xs p-1"><img src="/storage/assets/images/crypto-currencies/regular/Bitcoin.svg" alt=""></span>1.95ETH</p>
                                                        </div>
                                                    </div>
                                                </a>
                                            </li>
                                                ...
                                                <a href="javascript:void(0);">
                                                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2 lh-1">
                                                                <span class="avatar avatar-md">
                                                                    <img src="/storage/assets/images/nft-images/20.jpg" alt="">
                                                                </span>
                                                            </div>
                                                            <div>
                                                        ...
                                                        <div class="text-end">
                                                            <span class="fs-10 text-muted ps-4">PRICE</span>
                                                            <p class="mb-0 fw-medium d-flex align-items-center"><span class="avatar avatar-xs p-1"><img src="/storage/assets/images/crypto-currencies/regular/Bitcoin.svg" alt=""></span>1.12ETH</p>
                                                        </div>
                                                    </div>
                                                </a>
                                            </li>
   ...
   @include('zynix.partials.commonjs')
    ...
    <!-- NFT Dashboard -->
    <script src="/storage/assets/js/nft-dashboard.js"></script>
