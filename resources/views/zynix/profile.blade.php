...
<body>
                                ...
                                <div class="card custom-card profile-card">
                                    <div class="card-body pb-0 position-relative">
                                        <div class="profile-banner-img">
                                            <img src="/storage/assets/images/media/media-74.jpg" class="rounded w-100" alt="...">
                                        </div>
                                        ...
                                        <div class="card custom-card overflow-hidden">
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                                        <a href="/storage/assets/images/media/media-26.jpg"
                                                            class="glightbox card" data-gallery="gallery1">
                                                            <img src="/storage/assets/images/media/media-26.jpg" alt="image">
                                                        </a>
                                                    </div>
                                                    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                                        <a href="/storage/assets/images/media/media-32.jpg"
                                                            class="glightbox card" data-gallery="gallery1">
                                                            <img src="/storage/assets/images/media/media-32.jpg" alt="image">
                                                        </a>
                                                    </div>
                                                    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                                        <a href="/storage/assets/images/media/media-30.jpg"
                                                            class="glightbox card" data-gallery="gallery1">
                                                            <img src="/storage/assets/images/media/media-30.jpg" alt="image">
                                                        </a>
                                                    </div>
                                                    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                                        <a href="/storage/assets/images/media/media-31.jpg"
                                                            class="glightbox card" data-gallery="gallery1">
                                                            <img src="/storage/assets/images/media/media-31.jpg" alt="image">
                                                        </a>
                                                    </div>
                                                    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                                        <a href="/storage/assets/images/media/media-46.jpg"
                                                    ...
                                                    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                                        <a href="/storage/assets/images/media/media-59.jpg"
                                                            class="glightbox card" data-gallery="gallery1">
                                                            <img src="/storage/assets/images/media/media-59.jpg" alt="image">
                                                        </a>
                                                    </div>
                                                    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                                        <a href="/storage/assets/images/media/media-61.jpg"
                                                            class="glightbox card" data-gallery="gallery1">
   ...
   @include('zynix.partials.custom_switcherjs')
    ...
    <!-- Internal Profile JS -->
    <script src="/storage/assets/js/profile.js"></script>
