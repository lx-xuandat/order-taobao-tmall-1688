...
<!-- Treeview Css -->
<link rel="stylesheet" href="/storage/assets/libs/js-treeview/treeview.min.css">
...
<body>
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div>
                        <h1 class="page-title fw-medium fs-18 mb-2">Tree View</h1>
                        <div class="">
                            <nav>
   ...
   <!-- Treview JS -->
   <script src="/storage/assets/libs/js-treeview/treeview.min.js"></script>

    <!-- Internal Tour JS -->
    <script src="/storage/assets/js/treeview.js"></script>
