...
<body>
                                ...
                                <ul class="list-unstyled mb-0 analytics-visitors-countries">
                                    ...
                                    <li>
                                        <div class="d-flex align-items-center">
                                            <div class="lh-1">
                                                <span class="avatar avatar-xs avatar-rounded text-default">
                                                    <img src="/storage/assets/images/flags/canada_flag.jpg" alt="">
                                                </span>
                                            </div>
                                            <div class="ms-3 flex-fill lh-1">
                                    ...
                                    <li>
                                        <div class="d-flex align-items-center">
                                            <div class="lh-1">
                                                <span class="avatar avatar-xs avatar-rounded text-default">
                                                    <img src="/storage/assets/images/flags/india_flag.jpg" alt="">
                                                </span>
                                            </div>
                                            <div class="ms-3 flex-fill lh-1">
                                    ...
                                    <li>
                                        <div class="d-flex align-items-center">
                                            <div class="lh-1">
                                                <span class="avatar avatar-xs avatar-rounded text-default">
                                                    <img src="/storage/assets/images/flags/italy_flag.jpg" alt="">
                                                </span>
                                            </div>
                                            <div class="ms-3 flex-fill lh-1">
   ...
   @include('zynix.partials.commonjs')
    ...
    <!-- Analytics Dashboard -->
    <script src="/storage/assets/js/analytics-dashboard.js"></script>
