...
<!-- Toastify CSS -->
<link rel="stylesheet" href="/storage/assets/libs/toastify-js/src/toastify.css">
                                    ...
                                    <div class="toast-container position-fixed top-0 end-0 p-3">
                                        <div id="liveToast" class="toast" role="alert" aria-live="assertive"
                                            ...
                                            <div class="toast-header text-default">
                                                <img class="bd-placeholder-img rounded me-2" src="/storage/assets/images/brand-logos/favicon.ico" alt="...">
                                    ...
                                    <div class="toast-container position-fixed top-0 end-0 p-3">
                                        <div id="primaryToast" class="toast colored-toast bg-primary-transparent" role="alert" aria-live="assertive"
                                            ...
                                            <div class="toast-header bg-primary text-fixed-white">
                                                <img class="bd-placeholder-img rounded me-2" src="/storage/assets/images/brand-logos/toggle-dark.png" alt="...">
                                                <strong class="me-auto">Zynix</strong>
                                                <button type="button" class="btn-close" data-bs-dismiss="toast"
                                                    aria-label="Close"></button>
                                            </div>
...
<!-- Prism Code -->
   ...
   @include('zynix.partials.custom_switcherjs')
    ...
    <!-- Toastify JS -->
    <script src="/storage/assets/libs/toastify-js/src/toastify.js"></script>
    ...
    <!-- Toast JS -->
    <script src="/storage/assets/js/toasts.js"></script>
