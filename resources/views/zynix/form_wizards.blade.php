...
<body>
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div>
                        <h1 class="page-title fw-medium fs-18 mb-2">Form Wizards</h1>
                        <div class="">
                            <nav>
                                                                                       ...
                                                                                       <div class="d-sm-flex d-block align-items-center justify-content-between">
                                                                                           <div class="me-2 lh-1">
                                                                                               <span class="avatar avatar-md">
                                                                                                   <img src="/storage/assets/images/ecommerce/png/26.png" alt="">
                                                                                               </span>
                                                                                           </div>
                                                                                ...
                                                                                <div class="form-check payment-card-container mb-0 lh-1">
                                                                                    ...
                                                                                    <div class="form-check-label">
                                                                                       <div class="d-sm-flex d-block align-items-center justify-content-between">
                                                                                           <div class="me-2 lh-1">
                                                                                               <span class="avatar avatar-md">
                                                                                                   <img src="/storage/assets/images/ecommerce/png/27.png" alt="">
                                                                                               </span>
                                                                                           </div>
                                                                                           <div class="saved-card-details pe-5">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-12">
                                                    <div class="checkout-payment-success">
                                                        ...
                                                        <div class="mb-4">
                                                            <img src="/storage/assets/images/ecommerce/png/24.png" alt="" class="img-fluid">
                                                        </div>
                                                        <div class="mb-4">
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                <div id="basicwizard">
                                    <ul class="nav nav-tabs nav-justified flex-md-row flex-column mb-4 tab-style-6 p-0 gap-2">
                                        <li class="nav-item rounded" data-target-form="#contactDetailForm">
                                            <a class="nav-link bg-light  icon-btn d-flex align-items-center justify-content-md-center gap-1 active" data-bs-toggle="tab" data-toggle="tab" href="#contactDetail"><span>Contact Detail</span></a>
                                        </li>
                                        <li class="nav-item rounded" data-target-form="#jobDetailForm">
                                            <a class="nav-link bg-light  icon-btn d-flex align-items-center justify-content-md-center gap-1" data-bs-toggle="tab" data-toggle="tab" href="#jobDetail"><span>Job Detail</span></a>
                                        </li>
                                        <li class="nav-item rounded" data-target-form="#educationDetailForm">
                                            <a class="nav-link bg-light  icon-btn d-flex align-items-center justify-content-md-center gap-1" data-bs-toggle="tab" data-toggle="tab" href="#educationDetail"><span>Education Detail</span></a>
                                        </li>
                                        <li class="nav-item rounded">
                                            <a class="nav-link bg-light  icon-btn d-flex align-items-center justify-content-md-center gap-1" data-bs-toggle="tab" data-toggle="tab" href="#finish"><span>Finish</span></a>
                                        </li>
                                    </ul>
                                                    ...
                                                    <div class="text-center p-4">
                                                        ...
                                                        <div class="mb-0">
                                                            <div class="form-check d-inline-block">
                                                                <input class="form-check-input" id="customCheck1" required="" type="checkbox"> <label class="form-check-label" for="customCheck1">I agree with the <a class="fw-medium text-decoration-underline" href="terms_conditions.html">Terms and Conditions.</a></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div><!-- end col -->
                                            ...
                                            <div class="row d-flex justify-content-center">
                                                <div class="col-lg-10">
                                                    <div class="text-center p-4">
                                                        ...
                                                        <div class="mb-0">
                                                            <div class="form-check d-inline-block">
                                                                <input class="form-check-input" id="customCheck2" required="" type="checkbox"> <label class="form-check-label" for="customCheck2">I agree with the <a class="fw-medium text-decoration-underline" href="terms_conditions.html">Terms and Conditions.</a></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div><!-- end col -->
   ...
   @include('zynix.partials.custom_switcherjs')
    ...
    <!-- Vanilla-Wizard JS -->
    <script src="/storage/assets/libs/vanilla-wizard/js/wizard.min.js"></script>

    <!-- Internal Form Wizard JS -->
    <script src="/storage/assets/js/form-wizard.js"></script>
    <script src="/storage/assets/js/form-wizard-init.js"></script>
