                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                        ...
                                        <div class="btn-group ms-2">
                                            <button type="button" class="btn btn-outline-light border btn-sm dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                                <span class="avatar avatar-xs avatar-rounded me-2 align-middle"><img src="/storage/assets/images/crypto-currencies/crypto-icons/bitcoin-btc-logo.svg" alt=""></span>BTC
                                            </button>
                                    ...
                                    <div class="d-flex align-items-center flex-wrap justify-content-between gap-4 mb-3">
                                        ...
                                        <div>
                                            <span class="avatar avatar-xxl border">
                                                <img src="/storage/assets/images/media/media-68.png" class="p-1 qr-image" alt="">
                                            </span>
                                        </div>
                                    </div>
                                    <div class="row gy-3">
