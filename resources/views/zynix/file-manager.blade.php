...
<body>
                                    ...
                                    <div class="card-body">
                                        <div class="filemanager-upgrade-storage w-100 text-center">
                                            <span class="d-block mb-3"> <img
                                                    src="/storage/assets/images/media/file-manager/2.png" alt=""> </span>
                    ...
                    <div class="filemanager-file-details" id="filemanager-file-details">
                        <div class="p-3 text-center border-bottom border-block-end-dashed">
                            <div class="file-details mb-3">
                                <img src="/storage/assets/images/media/blog/9.jpg" alt="">
                            </div>
                            <div>
                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item">
                                    <div>
                                        ...
                                        <span class="fs-12 text-muted">This file contains 3 folder ZYNIX.main &
                                            ZYNIX.premium & ZYNIX.featured and 42 images and layout styles are added in
                                            this update.</span>
                                    </div>
                                </li>
                                <li class="list-group-item">
                                    ...
                                    <span
                                        class="fs-12 text-muted">Device/Storage/Archives/IMG-09123878-SPK734.jpeg</span>
                                </li>
                            </ul>
                        </div>
                        <div class="p-3 border-bottom border-block-end-dashed">
                            <p class="mb-1 fw-medium fs-14">Downloaded from :</p>
                            <a class="text-primary fw-medium text-break" href="https://themeforest.net/user/wcsrm"
                                target="_blank">
                                <u>https://themeforest.net/user/wcsrm</u>
                            </a>
                        </div>
                        <div class="p-3">
                            ...
                            <a href="javascript:void(0);">
                                <div class="d-flex align-items-center p-2">
                                    ...
                                    <span class="badge bg-success-transparent fw-normal">13,Nov 2024</span>
                                </div>
                            </a>
                        </div>
                    </div>
   ...
   @include('zynix.partials.custom_switcherjs')
    ...
    <script src="/storage/assets/js/file-manager.js"></script>
