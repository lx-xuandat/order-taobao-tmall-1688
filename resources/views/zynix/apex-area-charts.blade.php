...
<body>
                        ...
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="github-style d-flex align-items-center">
                                    <div class="me-2">
                                        <img class="userimg rounded" src="/storage/assets/images/faces/1.jpg"
   ...
   @include('zynix.partials.custom_switcherjs')
    ...
    <script src="/storage/assets/js/apex-github-data.js"></script>

    <!-- Used For Irregular Time Series Chart -->
    <script src="/storage/assets/js/apexcharts-irregulardata.js"></script>
    <script src="/storage/assets/libs/moment/min/moment.min.js"></script>

    <!-- Internal Apex Area Charts JS -->
    <script src="/storage/assets/js/apexcharts-area.js"></script>
