...
<body>
                                    ...
                                    <table class="table text-nowrap mb-0">
                                        ...
                                        <tbody class="">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex">
                                                        <span class="avatar avatar-sm align-items-center">
                                                            <img src="/storage/assets/images/company-logos/1.png" class="" alt="">
                                                        </span>
                                                        <div class="flex-1 ms-2">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex">
                                                        <span class="avatar avatar-sm align-items-center">
                                                            <img src="/storage/assets/images/faces/13.jpg" class="" alt="">
                                                        </span>
                                                        <div class="flex-1 ms-2">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex">
                                                        <span class="avatar avatar-sm align-items-center">
                                                            <img src="/storage/assets/images/company-logos/8.png" class="" alt="">
                                                        </span>
                                                        <div class="flex-1 ms-2">
                                        ...
                                        <tr>
                                                <td class="border-bottom-0 rounded">
                                                    <div class="d-flex">
                                                        <span class="avatar avatar-sm align-items-center">
                                                            <img src="/storage/assets/images/company-logos/9.png" class="" alt="">
                                                        </span>
                                                        <div class="flex-1 ms-2">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <span class="avatar avatar-sm">
                                                            <img src="/storage/assets/images/faces/12.jpg" class="" alt="">
                                                        </span>
                                                        <div class="flex-1 ms-2">
   ...
   @include('zynix.partials.commonjs')
    ...
    <!-- CRM Dashboard -->
    <script src="/storage/assets/js/crm-dashboard.js"></script>
