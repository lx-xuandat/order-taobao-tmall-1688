...
<body>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="text-center">
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar avatar-xs avatar-rounded me-2">
                                                            <img src="/storage/assets/images/flags/canada_flag.jpg" alt="img">
                                                        </div>
                                            ...
                                            <tr>
                                                <td class="text-center border-bottom-0">
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar avatar-xs avatar-rounded me-2">
                                                            <img src="/storage/assets/images/flags/mexico_flag.jpg" alt="img">
                                                        </div>
   ...
   @include('zynix.partials.commonjs')
    ...
    <!-- Jobs Dashboard -->
    <script src="/storage/assets/js/jobs-dashboard.js"></script>
