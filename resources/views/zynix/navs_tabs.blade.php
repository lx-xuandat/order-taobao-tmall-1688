                                            ...
                                            <table class="table mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th scope="row">
                                                            <span class="avatar avatar-sm">
                                                                <img src="/storage/assets/images/ecommerce/jpg/4.jpg" alt="img">
                                                            </span>
                                                        </th>
                                                        <td>Camera</td>
                                                        <td>Gadgets</td>
                                                    ...
                                                    <tr>
                                                        <th scope="row">
                                                            <span class="avatar avatar-sm">
                                                                <img src="/storage/assets/images/ecommerce/jpg/6.jpg" alt="img">
                                                            </span>
                                                        </th>
                                                        <td>Shoes</td>
                                                        <td>Footwear</td>
                                                    ...
                                                    <div>
                                                        <div class="my-md-auto mt-4 ms-md-3">
                                                            ...
                                                            <p class="text-muted ms-0 mb-2"><span><i
                                                                    ...
                                                                    class="font-weight-semibold me-2">Email:</span><span>wcsrm.space@gmail.com</span>
                                                            </p>
                                                            <p class="text-muted ms-0 mb-2"><span><i
                                                                        class="fe fe-globe me-2"></i></span><span
                                                                    class="font-weight-semibold me-2">Website:</span><span>wcsrmsoftware</span>
                                                            </p>
