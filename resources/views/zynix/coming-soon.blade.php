...
<body class="coming-soon-main position-relative" id="particles-js">
                    ...
                    <div class="row justify-content-center align-items-center mx-0 g-0">
                        <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-12 col-sm-12 col-12">
                            <div>
                                <div class="mb-2">
                                 <a href="index.html">
                                    <img src="/storage/assets/images/brand-logos/desktop-logo.png" alt="" class="authentication-brand desktop-light">
                                    <img src="/storage/assets/images/brand-logos/desktop-dark.png" alt="" class="authentication-brand desktop-logodark">
                                 </a>
                                </div>
    ...
    <script src="/storage/assets/js/coming-soon.js"></script>
