...
<body>
    ...
    <div class="page">
                                                    ...
                                                    <div>
                                                        <div class="avatar-list-stacked mb-2">
                                                            <span class="avatar avatar-rounded">
                                                                <img src="/storage/assets/images/faces/2.jpg" alt="img" class="p-1 bg-light">
                                                            </span>
                                                            <span class="avatar avatar-rounded">
                                                                <img src="/storage/assets/images/faces/8.jpg" alt="img" class="p-1 bg-light">
                                                            </span>
                                                            <span class="avatar avatar-rounded">
                                                                <img src="/storage/assets/images/faces/2.jpg" alt="img" class="p-1 bg-light">
                                                            </span>
        ...
        <!-- Contact Us Modal -->
        <div class="modal fade" id="contactus-modal" tabindex="-1"
             aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <div class="row gy-3">
                            ...
                            <div class="col-xl-12">
                                ...
                                <textarea class="form-control" placeholder="Enter your question here" id="text-area" rows="3"></textarea>
                            </div>
                        </div>
                    </div>
