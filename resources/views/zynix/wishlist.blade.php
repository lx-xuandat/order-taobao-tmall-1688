                                    ...
                                    <div class="col-4">
                                        <div class="rounded-2">
                                            <a href="javascript:void(0);">
                                                <img src="/storage/assets/images/ecommerce/jpg/06.jpg" alt="img" class="img-fluid bg-light w-100 rounded">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-8">
                            ...
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-4">
                                        <div class="rounded-2">
                                            <a href="javascript:void(0);">
                                                <img src="/storage/assets/images/ecommerce/jpg/12.jpg" alt="img" class="img-fluid bg-light w-100 rounded">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-8">
                            ...
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-4">
                                        <div class="rounded-2">
                                            <a href="javascript:void(0);">
                                                <img src="/storage/assets/images/ecommerce/jpg/05.jpg" alt="img" class="img-fluid bg-light w-100 rounded">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-8">
                            ...
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-4">
                                        <div class="rounded-2">
                                            <a href="javascript:void(0);">
                                                <img src="/storage/assets/images/ecommerce/jpg/3.jpg" alt="img" class="img-fluid bg-light w-100 rounded">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-8">
                            ...
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-4">
                                        <div class="rounded-2">
                                            <a href="javascript:void(0);">
                                                <img src="/storage/assets/images/ecommerce/jpg/15.jpg" alt="img" class="img-fluid bg-light w-100 rounded">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-8">
                            ...
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-4">
                                        <div class="rounded-2">
                                            <a href="javascript:void(0);">
                                                <img src="/storage/assets/images/ecommerce/jpg/1.jpg" alt="img" class="img-fluid bg-light w-100 rounded">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-8">
                            ...
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-4">
                                        <div class="rounded-2">
                                            <a href="javascript:void(0);">
                                                <img src="/storage/assets/images/ecommerce/jpg/07.jpg" alt="img" class="img-fluid bg-light rounded w-100">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-8">
                            ...
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-4">
                                        <div class="rounded-2">
                                            <a href="javascript:void(0);">
                                                <img src="/storage/assets/images/ecommerce/jpg/9.jpg" alt="img" class="img-fluid bg-light rounded w-100">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-8">
                            ...
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-4">
                                        <div class="rounded-2">
                                            <a href="javascript:void(0);">
                                                <img src="/storage/assets/images/ecommerce/jpg/08.jpg" alt="img" class="img-fluid bg-light rounded w-100">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-8">
                            ...
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-4">
                                        <div class="rounded-2">
                                            <a href="javascript:void(0);">
                                                <img src="/storage/assets/images/ecommerce/jpg/17.jpg" alt="img" class="img-fluid bg-light rounded w-100">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-8">
                            ...
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-4">
                                        <div class="rounded-2">
                                            <a href="javascript:void(0);">
                                                <img src="/storage/assets/images/ecommerce/jpg/02.jpg" alt="img" class="img-fluid rounded bg-light w-100">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-8">
                            ...
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-4">
                                        <div class="rounded-2">
                                            <a href="javascript:void(0);">
                                                <img src="/storage/assets/images/ecommerce/jpg/2.jpg" alt="img" class="img-fluid rounded bg-light w-100">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-8">
