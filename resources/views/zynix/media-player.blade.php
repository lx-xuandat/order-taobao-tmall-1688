...
<!-- Plyr CSS -->
<link rel="stylesheet" href="/storage/assets/libs/plyr/plyr.css">
...
<body>
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div>
                        <h1 class="page-title fw-medium fs-18 mb-2">Media Player</h1>
                        <div class="">
                            <nav>
                        ...
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                <audio id="player2" controls>
                                    <source src="/storage/assets/audio/perfect-beauty.mp3" type="audio/mp3" >
                                </audio>
                            </div>
                        </div>
                    </div>
   ...
   @include('zynix.partials.custom_switcherjs')
        ...
        <!-- Plyr JS -->
        <script src="/storage/assets/libs/plyr/plyr.min.js"></script>

    <!-- Internal Plyr JS -->
    <script src="/storage/assets/js/media-player.js"></script>
