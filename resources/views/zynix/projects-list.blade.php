                                                ...
                                                <div class="card-footer d-flex justify-content-between align-items-center">
                                                    <div class="avatar-list-stacked"> <span
                                                        ...
                                                        <span class="avatar avatar-sm avatar-rounded"> <img
                                                                src="/storage/assets/images/faces/8.jpg" alt="img"> </span>
                                            ...
                                            <div class="card custom-card">
                                                ...
                                                <div class="card-footer d-flex justify-content-between align-items-center">
                                                    <div class="avatar-list-stacked"> <span
                                                        ...
                                                        <span class="avatar avatar-sm avatar-rounded"> <img
                                                                src="/storage/assets/images/faces/7.jpg" alt="img"> </span>
                                                        <a class="avatar avatar-sm bg-primary avatar-rounded text-fixed-white"
                                                            href="javascript:void(0);"> +2 </a> </div>
                                                ...
                                                <div class="card-footer d-flex justify-content-between align-items-center">
                                                    <div class="avatar-list-stacked"> <span
                                                        ...
                                                        <span class="avatar avatar-sm avatar-rounded"> <img
                                                                src="/storage/assets/images/faces/5.jpg" alt="img"> </span>
                                                                <span class="avatar avatar-sm avatar-rounded"> <img
                                                                    src="/storage/assets/images/faces/9.jpg" alt="img"> </span>
                                                        <a class="avatar avatar-sm bg-primary avatar-rounded text-fixed-white"
                                                            href="javascript:void(0);"> +2 </a> </div>
                                                ...
                                                <div class="card-footer d-flex justify-content-between align-items-center">
                                                    <div class="avatar-list-stacked"> <span
                                                        ...
                                                        <span class="avatar avatar-sm avatar-rounded"> <img
                                                                src="/storage/assets/images/faces/8.jpg" alt="img"> </span>
                                                                <span class="avatar avatar-sm avatar-rounded"> <img
                                                                    src="/storage/assets/images/faces/8.jpg" alt="img"> </span> </div>
