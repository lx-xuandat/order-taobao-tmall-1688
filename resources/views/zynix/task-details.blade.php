                                ...
                                <div class="d-flex align-items-center gap-4 flex-wrap">
                                    <div class="p-2 border rounded d-flex align-items-center">
                                        <span class="avatar avatar-sm avatar-rounded me-2"><img
                                                src="/storage/assets/images/faces/1.jpg" alt="img"></span>
                                    ...
                                    <div class="p-2 border rounded d-flex align-items-center">
                                        <span class="avatar avatar-sm avatar-rounded me-2"><img
                                                src="/storage/assets/images/faces/2.jpg" alt="img"></span>
                                        <div class="d-flex flex-column lh-1">
                                            <span class="mb-1">
                                                Simon Cowall</span>
                                    ...
                                    <div class="p-2 border rounded d-flex align-items-center">
                                        <span class="avatar avatar-sm avatar-rounded me-2"><img
                                                src="/storage/assets/images/faces/3.jpg" alt="img"></span>
                                        <div class="d-flex flex-column lh-1">
                                            <span class="mb-1">
                                                Meisha Kerr</span>
                                    ...
                                    <div class="p-2 border rounded d-flex align-items-center">
                                        <span class="avatar avatar-sm avatar-rounded me-2"><img
                                                src="/storage/assets/images/faces/4.jpg" alt="img"></span>
                                        <div class="d-flex flex-column lh-1">
                                            <span class="mb-1">
                                                Jessica</span>
                                    ...
                                    <div class="p-2 border rounded d-flex align-items-center">
                                        <span class="avatar avatar-sm avatar-rounded me-2"><img
                                                src="/storage/assets/images/faces/5.jpg" alt="img"></span>
                                        <div class="d-flex flex-column lh-1">
                                            <span class="mb-1">
                                                Amanda B</span>
                                    ...
                                    <div class="p-2 border rounded d-flex align-items-center">
                                        <span class="avatar avatar-sm avatar-rounded me-2"><img
                                                src="/storage/assets/images/faces/6.jpg" alt="img"></span>
                                        <div class="d-flex flex-column lh-1">
                                            <span class="mb-1">
                                                Stathman</span>
                                            <span class="fs-11 text-muted">Web Developer</span>
                                    ...
                                    <div class="card-body p-0">
                                        <ul class="list-group border-0">
                                            <li class="list-group-item border-0 border-bottom px-3">
                                                <div class="d-flex align-items-start justify-content-between gap-3 flex-wrap">
                                                    <div class="d-flex align-items-center gap-2 mb-2"> <span class="avatar avatar-sm avatar-rounded"> <img
                                                                src="/storage/assets/images/faces/1.jpg" alt=""> </span><span
                                            ...
                                            <li class="list-group-item border-0 border-bottom px-3">
                                                <div class="d-flex align-items-start justify-content-between gap-3 flex-wrap">
                                                    <div class="d-flex align-items-center gap-2 mb-2"> <span class="avatar avatar-sm avatar-rounded"> <img
                                                                src="/storage/assets/images/faces/13.jpg" alt=""> </span><span
                                            ...
                                            <li class="list-group-item border-0 px-3">
                                                <div class="d-flex align-items-start justify-content-between gap-3 flex-wrap">
                                                    <div class="d-flex align-items-center gap-2 mb-2"> <span class="avatar avatar-sm avatar-rounded"> <img
                                                                src="/storage/assets/images/faces/15.jpg" alt=""> </span><span
                                                            ...
                                                            <div class="card-body">
                                                                <div class="mb-0 folder-svg-container d-flex flex-wrap align-items-center">
                                                                    <div class="svg-warning text-warning me-3 bg-light avatar avatar-md border">
                                                                       <img src="/storage/assets/images/media/file-manager/3.png" alt="img">
                                                                    </div>
                                                                    <div>
                                                            ...
                                                            <div class="card-body">
                                                                <div class="mb-0 folder-svg-container d-flex flex-wrap align-items-center">
                                                                    <div class="svg-warning text-warning me-3 bg-light avatar avatar-md border p-1">
                                                                       <img src="/storage/assets/images/media/file-manager/1.png" alt="img">
                                                                    </div>
                                                                    <div>
                                                                        <p class="fs-14 fw-medium mb-1 lh-1">
                                                                            <a href="javascript:void(0);">Images</a>
                                            ...
                                            <p class="text-muted">Every one should follow the deadline and complete the task as per the deadline.
                                               ...
                                               <div class="d-flex align-items-center gap-2 p-2 bg-light flex-wrap border rounded">
                                                <div class="p-2 border rounded d-flex bg-white align-items-center flex-wrap">
                                                    <span class="avatar avatar-sm avatar-rounded me-2"><img src="/storage/assets/images/faces/1.jpg" alt="img"></span>
                                                    <div class="d-flex flex-column lh-1">
                                                        <span class="mb-1">Robert Fox</span>
                                                        <span class="fs-11 text-muted">Web Developer</span>
                                                    </div>
                                                ...
                                                <div class="p-2 border rounded d-flex bg-white align-items-center flex-wrap">
                                                    <span class="avatar avatar-sm avatar-rounded me-2"><img src="/storage/assets/images/faces/2.jpg" alt="img"></span>
                                                    <div class="d-flex flex-column lh-1">
                                                        <span class="mb-1">
                                                            Simon Tensir</span>
                                                        <span class="fs-11 text-muted">Ui Tester</span>
