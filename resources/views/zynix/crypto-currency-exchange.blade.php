...
<body>
                                        ...
                                        <div class="d-flex align-items-center gap-2 mb-3">
                                            <div class="lh-1">
                                                <span class="avatar avatar-rounded avatar-xs">
                                                    <img src="/storage/assets/images/crypto-currencies/square-color/Bitcoin.svg" alt="">
                                                </span>
                                            </div>
                                ...
                                <div class="d-flex align-items-top justify-content-between mb-3 flex-wrap">
                                    <div>
                                        <div class="d-flex align-items-center gap-2 mb-3">
                                            <div class="lh-1">
                                                <span class="avatar avatar-rounded avatar-xs">
                                                    <img src="/storage/assets/images/crypto-currencies/square-color/Dash.svg" alt="">
                                                </span>
                                            </div>
                                ...
                                <div class="d-flex align-items-top justify-content-between mb-3 flex-wrap">
                                    <div>
                                        <div class="d-flex align-items-center gap-2 mb-3">
                                            <div class="lh-1">
                                                <span class="avatar avatar-rounded avatar-xs">
                                                    <img src="/storage/assets/images/crypto-currencies/square-color/Litecoin.svg" alt="">
                                                </span>
                                            </div>
                                ...
                                <div class="d-flex align-items-top justify-content-between mb-3 flex-wrap">
                                    <div>
                                        <div class="d-flex align-items-center gap-2 mb-3">
                                            <div class="lh-1">
                                                <span class="avatar avatar-rounded avatar-xs">
                                                    <img src="/storage/assets/images/crypto-currencies/square-color/Ripple.svg" alt="">
                                                </span>
                                            </div>
                                ...
                                <div class="d-flex align-items-top justify-content-between mb-3 flex-wrap">
                                    <div>
                                        <div class="d-flex align-items-center gap-2 mb-3">
                                            <div class="lh-1">
                                                <span class="avatar avatar-rounded avatar-xs">
                                                    <img src="/storage/assets/images/crypto-currencies/square-color/Golem.svg" alt="">
                                                </span>
                                            </div>
                                ...
                                <div class="d-flex align-items-top justify-content-between mb-3 flex-wrap">
                                    <div>
                                        <div class="d-flex align-items-center gap-2 mb-3">
                                            <div class="lh-1">
                                                <span class="avatar avatar-rounded avatar-xs">
                                                    <img src="/storage/assets/images/crypto-currencies/square-color/Monero.svg" alt="">
                                                </span>
                                            </div>
                                ...
                                <div class="d-flex align-items-top justify-content-between mb-3 flex-wrap">
                                    <div>
                                        <div class="d-flex align-items-center gap-2 mb-3">
                                            <div class="lh-1">
                                                <span class="avatar avatar-rounded avatar-xs">
                                                    <img src="/storage/assets/images/crypto-currencies/square-color/EOS.svg" alt="">
                                                </span>
                                            </div>
   ...
   @include('zynix.partials.custom_switcherjs')
    ...
    <script src="/storage/assets/js/crypto-currency-exchange.js"></script>
