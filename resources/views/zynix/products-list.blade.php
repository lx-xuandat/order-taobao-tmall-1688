                                                    ...
                                                    <div class="d-flex">
                                                        <span
                                                            class="avatar avatar-md avatar-square bg-primary-transparent p-1"><img
                                                                src="/storage/assets/images/ecommerce/png/1.png"
                                                    ...
                                                    <div class="d-flex">
                                                        <span
                                                            class="avatar avatar-md avatar-square bg-secondary-transparent p-1"><img
                                                                src="/storage/assets/images/ecommerce/png/14.png"
                                                                class="w-100 h-100" alt="..."></span>
                                                        <div class="ms-2">
                                                            <p class="fw-semibold mb-0 d-flex align-items-center"><a
                                                    ...
                                                    <div class="d-flex">
                                                        <span
                                                            class="avatar avatar-md avatar-square bg-success-transparent p-1"><img
                                                                src="/storage/assets/images/ecommerce/png/33.png"
                                                                class="w-100 h-100" alt="..."></span>
                                                        <div class="ms-2">
                                                            <p class="fw-semibold mb-0 d-flex align-items-center"><a
                                                    ...
                                                    <div class="d-flex">
                                                        <span
                                                            class="avatar avatar-md avatar-square bg-info-transparent p-1"><img
                                                                src="/storage/assets/images/ecommerce/png/10.png"
                                                                class="w-100 h-100" alt="..."></span>
                                                        <div class="ms-2">
                                                            <p class="fw-semibold mb-0 d-flex align-items-center"><a
                                                    ...
                                                    <div class="d-flex">
                                                        <span
                                                            class="avatar avatar-md avatar-square bg-warning-transparent p-1"><img
                                                                src="/storage/assets/images/ecommerce/png/34.png"
                                                                class="w-100 h-100" alt="..."></span>
                                                        <div class="ms-2">
                                                            <p class="fw-semibold mb-0 d-flex align-items-center"><a
                                                    ...
                                                    <div class="d-flex">
                                                        <span
                                                            class="avatar avatar-md avatar-square bg-pink-transparent p-1"><img
                                                                src="/storage/assets/images/ecommerce/png/31.png"
                                                                class="w-100 h-100" alt="..."></span>
                                                        <div class="ms-2">
                                                            <p class="fw-semibold mb-0 d-flex align-items-center"><a
                                            ...
                                            <tr class="product-list">
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <span
                                                            class="avatar avatar-md avatar-square bg-info-transparent p-1"><img
                                                                src="/storage/assets/images/ecommerce/png/35.png"
                                                                class="w-100 h-100" alt="..."></span>
                                                        <div class="ms-2">
                                                            <p class="fw-semibold mb-0 d-flex align-items-center"><a
