...
<body>
                                                    ...
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-xs avatar-rounded">
                                                                <img src="/storage/assets/images/crypto-currencies/square-color/Bitcoin.svg"
                                                                    alt="">
                                                            </span>
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-xs avatar-rounded">
                                                                <img src="/storage/assets/images/crypto-currencies/square-color/Ethereum.svg"
                                                                    alt="">
                                                            </span>
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-xs avatar-rounded">
                                                                <img src="/storage/assets/images/crypto-currencies/square-color/Golem.svg"
                                                                    alt="">
                                                            </span>
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-xs avatar-rounded">
                                                                <img src="/storage/assets/images/crypto-currencies/square-color/Dash.svg"
                                                                    alt="">
                                                            </span>
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-xs avatar-rounded">
                                                                <img src="/storage/assets/images/crypto-currencies/square-color/Litecoin.svg"
                                                                    alt="">
                                                            </span>
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-xs avatar-rounded">
                                                                <img src="/storage/assets/images/crypto-currencies/square-color/Ripple.svg"
                                                                    alt="">
                                                            </span>
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-xs avatar-rounded">
                                                                <img src="/storage/assets/images/crypto-currencies/square-color/EOS.svg"
                                                                    alt="">
                                                            </span>
                                                        </div>
                                ...
                                <ul class="list-group list-group-flush">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                            <div class="d-flex align-items-center gap-2">
                                                <div> <span class="avatar avatar-sm p-1 bg-light"> <img
                                                            src="/storage/assets/images/crypto-currencies/regular/Bitcoin.svg"
                                                            alt=""> </span> </div>
                                    ...
                                    <li class="list-group-item">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                            <div class="d-flex align-items-center gap-2">
                                                <div> <span class="avatar avatar-sm p-1 bg-light"> <img
                                                            src="/storage/assets/images/crypto-currencies/regular/litecoin.svg"
                                                            alt=""> </span> </div>
                                    ...
                                    <li class="list-group-item">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                            <div class="d-flex align-items-center gap-2">
                                                <div> <span class="avatar avatar-sm p-1 bg-light"> <img
                                                            src="/storage/assets/images/crypto-currencies/regular/Golem.svg"
                                                            alt=""> </span> </div>
                                    ...
                                    <li class="list-group-item">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                            <div class="d-flex align-items-center gap-2">
                                                <div> <span class="avatar avatar-sm p-1 bg-light"> <img
                                                            src="/storage/assets/images/crypto-currencies/regular/Dash.svg"
                                                            alt=""> </span> </div>
                                    ...
                                    <li class="list-group-item">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                            <div class="d-flex align-items-center gap-2">
                                                <div> <span class="avatar avatar-sm p-1 bg-light"> <img
                                                            src="/storage/assets/images/crypto-currencies/regular/Ripple.svg"
                                                            alt=""> </span> </div>
                                    ...
                                    <li class="list-group-item">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                            <div class="d-flex align-items-center gap-2">
                                                <div> <span class="avatar avatar-sm p-1 bg-light"> <img
                                                            src="/storage/assets/images/crypto-currencies/regular/EOS.svg"
                                                            alt=""> </span> </div>
   ...
   @include('zynix.partials.custom_switcherjs')
    ...
    <!-- Crypto MarketCap JS -->
    <script src="/storage/assets/js/crypto-marketcap.js"></script>
