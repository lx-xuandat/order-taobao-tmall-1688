...
<body>
                            ...
                            <div class="col-xxl-12 col-sm-12 mb-4">
                                <div
                                    ...
                                    <div class="swiper-wrapper" id="swiper-wrapper-fb3da8f89b677915" aria-live="polite">
                                        <div class="swiper-slide p-2 bg-white">
                                            <img class="img-fluid" src="/storage/assets/images/nft-images/8.jpg" alt="img">
                                        </div>
                                        <div class="swiper-slide p-2 bg-white">
                                            <img class="img-fluid" src="/storage/assets/images/nft-images/2.jpg" alt="img">
                                        </div>
                                        <div class="swiper-slide p-2 bg-white"> <img class="img-fluid"
                                                src="/storage/assets/images/nft-images/4.jpg" alt="img">
                                        </div>
                                        <div class="swiper-slide p-2 bg-white"> <img class="img-fluid"
                                                src="/storage/assets/images/nft-images/5.jpg" alt="img">
                                        </div>
                                    </div>
                                ...
                                <div
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide p-2 bg-white"> <img class="img-fluid"
                                                src="/storage/assets/images/nft-images/8.jpg" alt="img"> </div>
                                        <div class="swiper-slide p-2 bg-white"> <img class="img-fluid"
                                                src="/storage/assets/images/nft-images/2.jpg" alt="img"> </div>
                                        <div class="swiper-slide p-2 bg-white"> <img class="img-fluid"
                                                src="/storage/assets/images/nft-images/4.jpg" alt="img"> </div>
                                        <div class="swiper-slide p-2 bg-white"> <img class="img-fluid"
                                                src="/storage/assets/images/nft-images/5.jpg" alt="img"> </div>
                                        ...
                                        <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 col-sm-12 mt-xxl-0 mt-3">
                                            ...
                                            <div class="d-flex align-items-center fw-medium"> <span
                                                    class="avatar avatar-xs avatar-rounded lh-1 me-1"><img
                                                        src="/storage/assets/images/faces/9.jpg" alt=""></span> Luna Park
                                            </div>
                                        </div>
                                        <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 col-sm-12 mt-xxl-0 mt-3">
                                    ...
                                    <div class="mb-4 mt-4">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-2"> <span class="fw-semibold text-muted fs-14">Loan
                                                ...
                                                <div class="d-flex align-items-center mt-1"> <span
                                                        class="avatar avatar-xs"> <img
                                                            src="/storage/assets/images/crypto-currencies/crypto-icons/ethereum-eth-logo.svg"
                                            ...
                                            <div class="col-sm-3"> <span class="fw-semibold text-muted fs-14">Balckchain :</span>
                                                <div class="d-flex gap-1 mt-1 align-items-center"> <div class="avatar avatar-sm avatar-rounded p-1 bg-primary-transparent me-2 border border-primary border-opacity-10"> <img src="/storage/assets/images/crypto-currencies/regular/Ethereum.svg" alt=""> </div> <span class="mb-0 fs-14"> Ethereum</span> </div>
                                            </div>
                                        </div>
                                    </div>
                                                            ...
                                                            <div class="col-xl-6">
                                                                <div class="products-review-images"> <a
                                                                        href="javascript:void(0);"> <img
                                                                            src="/storage/assets/images/nft-images/13.jpg"
                                                                            alt="">
                                                                    </a> <a href="javascript:void(0);"> <img
                                                                            src="/storage/assets/images/nft-images/15.jpg"
                                                                            alt="">
                                                                    </a> </div>
                                                            </div>
                                                            <div
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xxl-4 col-lg-6">
                                            <div class="card custom-card">
                                                <div class="card-body">
                                                    <div class="position-relative mb-3 overflow-hidden rounded">
                                                        <img src="/storage/assets/images/nft-images/6.jpg" class="card-img rounded" alt="...">
                                                        <p class="mb-0 bg-secondary text-fixed-white nft-auction-time"> 04hrs : 24m : 38s </p>
                                                        <div class="nft-content">
                                                            <a href="javascript:void(0);" class="fs-14 fw-bold text-fixed-white">CryptoCanvas</a>
                                                            <div class="d-flex mb-0 align-items-center flex-wrap gap-2 justify-content-between">
                                        ...
                                        <tbody>
                                                ...
                                                <td> <a href="javascript:void(0);">
                                                        <div class="d-flex align-items-top">
                                                            <div class="avatar p-1 bg-gray-300 me-2"> <img
                                                                    src="/storage/assets/images/nft-images/16.jpg" alt="">
                                                            </div>
                                                            <div class="flex-fill">
                                                                <p
                                                    ...
                                                    <div>
                                                        <p class="mb-0 fw-semibold d-flex align-items-center fs-16 justify-content-end"><span
                                                            class="avatar avatar-xs avatar-rounded p-1"><img
                                                                src="/storage/assets/images/crypto-currencies/regular/Ethereum.svg"
                                            ...
                                            <tr>
                                                <td> <a href="javascript:void(0);">
                                                        <div class="d-flex align-items-top">
                                                            <div class="avatar p-1 bg-gray-300 me-2"> <img
                                                                    src="/storage/assets/images/nft-images/17.jpg" alt="">
                                                            </div>
                                                            <div class="flex-fill">
                                                                <p
                                                                    class="mb-0  fs-14 fw-medium similar-product-name text-truncate">
                                            ...
                                            <tr>
                                                <td> <a href="javascript:void(0);">
                                                        <div class="d-flex align-items-top">
                                                            <div class="avatar p-1 bg-gray-300 me-2"> <img
                                                                    src="/storage/assets/images/nft-images/18.jpg" alt="">
                                                            </div>
                                                            <div class="flex-fill">
                                                                <p
                                            ...
                                            <tr>
                                                <td> <a href="javascript:void(0);">
                                                        <div class="d-flex align-items-top">
                                                            <div class="avatar p-1 bg-gray-300 me-2"> <img
                                                                    src="/storage/assets/images/nft-images/10.jpg" alt="">
                                                            </div>
                                                            <div class="flex-fill">
                                                                <p
                                                                    class="mb-0 fw-medium similar-product-name text-truncate">
                                            ...
                                            <tr>
                                                <td> <a href="javascript:void(0);">
                                                        <div class="d-flex align-items-top">
                                                            <div class="avatar p-1 bg-gray-300 me-2"> <img
                                                                    src="/storage/assets/images/nft-images/11.jpg" alt="">
                                                            </div>
                                                            <div class="flex-fill">
                                                                <p
                                                                    class="mb-0 fw-medium similar-product-name text-truncate">
                                            ...
                                            <tr>
                                                <td> <a href="javascript:void(0);">
                                                        <div class="d-flex align-items-top">
                                                            <div class="avatar p-1 bg-gray-300 me-2"> <img
                                                                    src="/storage/assets/images/nft-images/9.jpg" alt="">
                                                            </div>
                                                            <div class="flex-fill">
                                                                <p
                                                                    class="mb-0 fw-medium similar-product-name text-truncate">
                                            ...
                                            <tr>
                                                <td> <a href="javascript:void(0);">
                                                        <div class="d-flex align-items-top">
                                                            <div class="avatar p-1 bg-gray-300 me-2"> <img
                                                                    src="/storage/assets/images/nft-images/13.jpg" alt="">
                                                            </div>
                                                            <div class="flex-fill">
                                                                <p
                                                                    class="mb-0 fw-medium similar-product-name text-truncate">
                                            ...
                                            <tr>
                                                <td> <a href="javascript:void(0);">
                                                        <div class="d-flex align-items-top">
                                                            <div class="avatar p-1 bg-gray-300 me-2"> <img
                                                                    src="/storage/assets/images/nft-images/12.jpg" alt="">
                                                            </div>
                                                            <div class="flex-fill">
                                                                <p
                                                                    class="mb-0 fw-medium similar-product-name text-truncate">
   ...
   @include('zynix.partials.custom_switcherjs')
    ...
    <script src="/storage/assets/js/nft-details.js"></script>
