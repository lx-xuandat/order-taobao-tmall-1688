...
<body>
                                    ...
                                    <table class="table text-nowrap teachers-list">
                                        ...
                                        <tbody class="">
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <img src="/storage/assets/images/faces/11.jpg" alt="" class="avatar avatar-sm">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <img src="/storage/assets/images/faces/3.jpg" alt="" class="avatar avatar-sm">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <img src="/storage/assets/images/faces/4.jpg" alt="" class="avatar avatar-sm">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <img src="/storage/assets/images/faces/1.jpg" alt="" class="avatar avatar-sm">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <img src="/storage/assets/images/faces/15.jpg" alt="" class="avatar avatar-sm">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <img src="/storage/assets/images/faces/2.jpg" alt="" class="avatar avatar-sm">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <img src="/storage/assets/images/faces/5.jpg" alt="" class="avatar avatar-sm">
                                            ...
                                            <tr>
                                                <td class="border-bottom-0">
                                                    <div class="d-flex align-items-center gap-3">
                                                        <img src="/storage/assets/images/faces/6.jpg" alt="" class="avatar avatar-sm">
   ...
   @include('zynix.partials.commonjs')
    ...
    <!-- School dashboard -->
    <script src="/storage/assets/js/school-dashboard.js"></script>
