...
<link rel="stylesheet" href="/storage/assets/libs/dragula/dragula.min.css">
...
<body>
                                            ...
                                            <div class="p-3 kanban-board-head">
                                                ...
                                                <div class="kanban-content mt-2 mb-3">
                                                    <div class="task-image mt-2">
                                                        <img src="/storage/assets/images/media/media-36.jpg"
                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body p-0">
                                            <div class="p-3 kanban-board-head">
                                                ...
                                                <div class="kanban-content mt-2 mb-3">
                                                    <div class="task-image mt-2">
                                                        <img src="/storage/assets/images/media/media-41.jpg"
                                                            class="img-fluid rounded kanban-image" alt="">
                                                    </div>
                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body p-0">
                                            <div class="p-3 kanban-board-head">
                                                ...
                                                <div class="kanban-content mt-2 mb-3">
                                                    <div class="task-image mt-2">
                                                        <img src="/storage/assets/images/media/media-43.jpg"
                                                            class="img-fluid rounded kanban-image" alt="">
                                                    </div>
                                ...
                                <div class="card custom-card">
                                    <div class="card-body p-0">
                                        <div class="p-3 kanban-board-head">
                                            ...
                                            <div class="kanban-content mt-2 mb-3">
                                                <div class="task-image mt-2">
                                                    <img src="/storage/assets/images/media/media-69.jpg"
   ...
   @include('zynix.partials.custom_switcherjs')
    ...
    <script
        src="/storage/assets/libs/filepond-plugin-image-exif-orientation/filepond-plugin-image-exif-orientation.min.js"></script>
    ...
    <!-- Dragula JS -->
    <script src="/storage/assets/libs/dragula/dragula.min.js"></script>

    <!-- Internal Task  JS -->
    <script src="/storage/assets/js/task-kanban-board.js"></script>
