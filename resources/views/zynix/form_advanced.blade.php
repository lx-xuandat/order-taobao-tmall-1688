...
<!-- Auto Complete CSS -->
<link rel="stylesheet" href="/storage/assets/libs/@tarekraafat/autocomplete.js/css/autoComplete.css">

<!-- intl-tel-input css -->
<link rel="stylesheet" href="/storage/assets/libs/intl-tel-input/build/css/intlTelInput.min.css">

<!-- Tagify CSS -->
<link rel="stylesheet" href="/storage/assets/libs/@yaireo/tagify/tagify.css">

<!-- Dragsort CSS -->
<link rel="stylesheet" href="/storage/assets/libs/@yaireo/dragsort/dragsort.css">

<!-- Dual ListBox CSS -->
<link rel="stylesheet" href="/storage/assets/libs/dual-listbox/dual-listbox.css">
...
<body>
   ...
   @include('zynix.partials.custom_switcherjs')
    ...
    <!-- intl-tel-input JS -->
    <script src="/storage/assets/libs/intl-tel-input/build/js/intlTelInput.min.js"></script>

    <!-- Tagify JS -->
    <script src="/storage/assets/libs/@yaireo/tagify/tagify.js"></script>

    <!-- Dragsort JS -->
    <script src="/storage/assets/libs/@yaireo/dragsort/dragsort.js"></script>

    <!-- Dual ListBox JS -->
    <script src="/storage/assets/libs/dual-listbox/dual-listbox.js"></script>

    <!-- Internal Advanced Forms JS -->
    <script src="/storage/assets/js/form-advanced.js"></script>

    <!-- Internal Tagify JS -->
    <script src="/storage/assets/js/tagify.js"></script>
