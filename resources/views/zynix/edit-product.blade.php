...
<body>
                                        ...
                                        <div class="product-dropzone">
                                            ...
                                            <div class="mb-3">
                                                <span class="avatar avatar-xl border me-2 bg-light">
                                                    <img src="/storage/assets/images/ecommerce/png/1.png" alt="" class="w-100 h-100">
                                                    <a href="javascript:void(0);" class="badge rounded-pill bg-danger avatar-badge"><i class="fe fe-x"></i></a>
                                                </span>
                                                <span class="avatar avatar-xl border me-2 bg-light">
                                                    <img src="/storage/assets/images/ecommerce/png/14.png" alt="" class="w-100 h-100">
                                                    <a href="javascript:void(0);" class="badge rounded-pill bg-danger avatar-badge"><i class="fe fe-x"></i></a>
                                                </span>
                                                <span class="avatar avatar-xl border me-2 bg-light">
                                                    <img src="/storage/assets/images/ecommerce/png/31.png" alt="" class="w-100 h-100">
                                                    <a href="javascript:void(0);" class="badge rounded-pill bg-danger avatar-badge"><i class="fe fe-x"></i></a>
                                                </span>
                                                <span class="avatar avatar-xl border me-2 bg-light">
                                                    <img src="/storage/assets/images/ecommerce/png/36.png" alt="" class="w-100 h-100">
                                                    <a href="javascript:void(0);" class="badge rounded-pill bg-danger avatar-badge"><i class="fe fe-x"></i></a>
                                                </span>
                                            </div>
   ...
   @include('zynix.partials.custom_switcherjs')
    ...
    <script src="/storage/assets/js/edit-products.js"></script>
