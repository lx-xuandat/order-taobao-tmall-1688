...
<body>
                                ...
                                <ul class="list-unstyled mb-0 top-country-sales">
                                        ...
                                        <div class="d-flex align-items-center flex-wrap gap-2">
                                            <div class="lh-1">
                                                <span class="avatar avatar-md p-2 bg-light border avatar-rounded">
                                                    <img src="/storage/assets/images/flags/us_flag.jpg" alt="">
                                                </span>
                                            </div>
                                    ...
                                    <li>
                                        <div class="d-flex align-items-center flex-wrap gap-2">
                                            <div class="lh-1">
                                                <span class="avatar avatar-md p-2 bg-light border avatar-rounded">
                                                    <img src="/storage/assets/images/flags/germany_flag.jpg" alt="">
                                                </span>
                                            </div>
                                            <div class="flex-fill lh-1">
                                    ...
                                    <li>
                                        <div class="d-flex align-items-center flex-wrap gap-2">
                                            <div class="lh-1">
                                                <span class="avatar avatar-md p-2 bg-light border avatar-rounded">
                                                    <img src="/storage/assets/images/flags/mexico_flag.jpg" alt="">
                                                </span>
                                            </div>
                                            <div class="flex-fill lh-1">
                                    ...
                                    <li>
                                        <div class="d-flex align-items-center flex-wrap gap-2">
                                            <div class="lh-1">
                                                <span class="avatar avatar-md p-2 bg-light border avatar-rounded">
                                                    <img src="/storage/assets/images/flags/uae_flag.jpg" alt="">
                                                </span>
                                            </div>
                                            <div class="flex-fill lh-1">
                                    ...
                                    <li>
                                        <div class="d-flex align-items-center flex-wrap gap-2">
                                            <div class="lh-1">
                                                <span class="avatar avatar-md p-2 bg-light border avatar-rounded">
                                                    <img src="/storage/assets/images/flags/argentina_flag.jpg" alt="">
                                                </span>
                                            </div>
                                            <div class="flex-fill lh-1">
                                    ...
                                    <li>
                                        <div class="d-flex align-items-center flex-wrap gap-2">
                                            <div class="lh-1">
                                                <span class="avatar avatar-md p-2 bg-light border avatar-rounded">
                                                    <img src="/storage/assets/images/flags/russia_flag.jpg" alt="">
                                                </span>
                                            </div>
                                            <div class="flex-fill lh-1">
                                    ...
                                    <table class="table text-nowrap">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <span class="avatar avatar-md bg-light"><img src="/storage/assets/images/ecommerce/png/1.png" class="" alt="..."></span>
                                                        <div class="ms-2">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <span class="avatar avatar-md bg-light"><img src="/storage/assets/images/ecommerce/png/36.png" class="" alt="..."></span>
                                                        <div class="ms-2">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <span class="avatar avatar-md bg-light"><img src="/storage/assets/images/ecommerce/png/31.png" class="" alt="..."></span>
                                                        <div class="ms-2">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <span class="avatar avatar-md bg-light"><img src="/storage/assets/images/ecommerce/png/14.png" class="" alt="..."></span>
                                                        <div class="ms-2">
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-bottom-0">
                                                    <div class="d-flex">
                                                        <span class="avatar avatar-md bg-light"><img src="/storage/assets/images/ecommerce/png/13.png" class="" alt="..."></span>
                                                        <div class="ms-2">
                                ...
                                <ul class="list-unstyled visitors-browser-list">
                                        ...
                                        <div class="d-flex align-items-center gap-2 flex-wrap">
                                            <div>
                                                <span class="avatar avatar-md avatar-rounded bg-light p-2 border">
                                                    <img src="/storage/assets/images/browsers/chrome.png" alt="">
                                                </span>
                                            </div>
                                            <div class="flex-fill">
                                    ...
                                    <li>
                                        <div class="d-flex align-items-center gap-2 flex-wrap">
                                            <div>
                                                <span class="avatar avatar-md avatar-rounded bg-light p-2 border">
                                                    <img src="/storage/assets/images/browsers/edge.png" alt="">
                                                </span>
                                            </div>
                                            <div class="flex-fill">
                                                <div class="d-flex align-items-center justify-content-between mb-2 flex-wrap">
                                    ...
                                    <li>
                                        <div class="d-flex align-items-center gap-2 flex-wrap">
                                            <div>
                                                <span class="avatar avatar-md avatar-rounded bg-light p-2 border">
                                                    <img src="/storage/assets/images/browsers/firefox.png" alt="">
                                                </span>
                                            </div>
                                            <div class="flex-fill">
                                                <div class="d-flex align-items-center justify-content-between mb-2 flex-wrap">
                                    ...
                                    <li>
                                        <div class="d-flex align-items-center gap-2 flex-wrap">
                                            <div>
                                                <span class="avatar avatar-md avatar-rounded bg-light p-2 border">
                                                    <img src="/storage/assets/images/browsers/safari.png" alt="">
                                                </span>
                                            </div>
                                            <div class="flex-fill">
                                                <div class="d-flex align-items-center justify-content-between mb-2 flex-wrap">
                                    ...
                                    <li>
                                        <div class="d-flex align-items-center gap-2 flex-wrap">
                                            <div>
                                                <span class="avatar avatar-md avatar-rounded bg-light p-2 border">
                                                    <img src="/storage/assets/images/browsers/uc.png" alt="">
                                                </span>
                                            </div>
                                            <div class="flex-fill">
                                                <div class="d-flex align-items-center justify-content-between mb-2 flex-wrap">
                                    ...
                                    <li>
                                        <div class="d-flex align-items-center gap-2 flex-wrap">
                                            <div>
                                                <span class="avatar avatar-md avatar-rounded bg-light p-2 border">
                                                    <img src="/storage/assets/images/browsers/opera.png" alt="">
                                                </span>
                                            </div>
                                            <div class="flex-fill">
                                                <div class="d-flex align-items-center justify-content-between mb-2 flex-wrap">
                                    ...
                                    <li>
                                        <div class="d-flex align-items-center gap-2 flex-wrap">
                                            <div>
                                                <span class="avatar avatar-md avatar-rounded bg-light p-2 border">
                                                    <img src="/storage/assets/images/browsers/samsung-internet.png" alt="">
                                                </span>
                                            </div>
                                            <div class="flex-fill">
                                                <div class="d-flex align-items-center justify-content-between mb-2 flex-wrap">
   ...
   @include('zynix.partials.commonjs')
    ...
    <!-- Sales Dashboard -->
    <script src="/storage/assets/js/sales-dashboard.js"></script>
