    ...
    <div class="main-sidebar" id="sidebar-scroll">
        ...
        <nav class="main-menu-container nav nav-pills flex-column sub-open">
            ...
            <ul class="main-menu">
                ...
                <!-- Start::slide -->
                <li class="slide">
                    <a href="{{ route('fe.cart.index') }}" class="side-menu__item {{ request()->routeIs(['fe.cart.*']) ? 'active' : null }}">
                ...
                <!-- Start::slide -->
                <li class="slide">
                    <a href="{{ route('fe.cart.index') }}" class="side-menu__item">
                ...
                <li class="slide">
                    <a href="{{ route('fe.cart.index') }}" class="side-menu__item">
                        ...
                        <span class="side-menu__label">Waybills</span>
                    </a>
                </li>
                <!-- End::slide -->
