...
<head>
    ...
    <!-- Main Theme Js -->
    <script src="/storage/assets/js/authentication-main.js"></script>
...
<body class="authenticationcover-background bg-primary-transparent position-relative" id="particles-js">
                  ...
                  <div class="col-xxl-6 col-xl-5 col-lg-12 d-xl-block d-none px-0">
                      <div class="authentication-cover overflow-hidden">
                          <div class="authentication-cover-logo">
                              <a href="index.html">
                                  <img src="/storage/assets/images/brand-logos/desktop-dark.png" alt="" class="authentication-brand desktop-dark">
                              </a>
                          </div>
                                ...
                                <div class="col-xl-10">
                                  <div class="rounded bg-white-transparent authentication-sub-content">
                                    <div class="d-flex align-items-center justify-content-center">
                                        <img src="/storage/assets/images/media/media-80.png" alt="img">
                                    </div>
                                  ...
                                  <div class="card-body p-5">
                                     <div class="d-flex align-items-center justify-content-center mb-3">
                                      ...
                                      <div class="text-center">
                                          <p class="text-muted mt-3 mb-0">Back to home ? <a href="index.html" class="text-primary">Click Here</a></p>
                                      </div>
                                  </div>
                              </div>
                          </div>
    ...
    <script src="/storage/assets/libs/bootstrap/js/bootstrap.bundle.min.js"></script>
      ...
      <!-- Particles JS -->
      <script src="/storage/assets/libs/particles.js/particles.js"></script>

      <script src="/storage/assets/js/cover-password.js"></script>

    <!-- Show Password JS -->
    <script src="/storage/assets/js/show-password.js"></script>
