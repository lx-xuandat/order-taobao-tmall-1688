...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="/storage/assets/images/brand-logos/favicon.ico" type="image/x-icon">

    <!-- Bootstrap Css -->
    <link id="style" href="/storage/assets/libs/bootstrap/css/bootstrap.min.css" rel="stylesheet">

    <!-- Style Css -->
    <link href="/storage/assets/css/styles.css" rel="stylesheet">

    <!-- Icons Css -->
    <link href="/storage/assets/css/icons.css" rel="stylesheet">

    <!-- Node Waves Css -->
    <link href="/storage/assets/libs/node-waves/waves.min.css" rel="stylesheet">
    ...
    <link rel="stylesheet" href="/storage/assets/libs/@simonwep/pickr/themes/nano.min.css">

    <!-- Choices Css -->
    <link rel="stylesheet" href="/storage/assets/libs/choices.js/public/assets/styles/choices.min.css">
    ...
    <script>
        ...
        if (localStorage.zynixlandingrtl) {
            ...
            document.querySelector("#style")?.setAttribute("href", "/storage/assets/libs/bootstrap/css/bootstrap.rtl.min.css");
        }
    </script>
...
<body class="landing-body">
                ...
                <div class="main-sidebar">
                    ...
                    <nav class="main-menu-container nav nav-pills sub-open">
                        <div class="landing-logo-container">
                            <div class="horizontal-logo">
                                <a href="index.html" class="header-logo">
                                    <img src="/storage/assets/images/brand-logos/desktop-logo.png" alt="logo"
                                        class="desktop-logo">
                                    <img src="/storage/assets/images/brand-logos/desktop-dark.png" alt="logo"
                                        class="desktop-dark">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-4 my-auto position-relative">
                                <div class="text-end landing-main-image landing-heading-img">
                                    <img src="/storage/assets/images/media/media-78.png" alt="" class="img-fluid">
                                </div>
                    ...
                    <div class="row gx-5 mx-0">
                        <div class="col-xl-5">
                            <div class="home-proving-image d-none d-xl-block">
                                <img src="/storage/assets/images/media/media-79.png" alt="" class="img-fluid] about-image">
                            </div>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-xl-10 my-auto">
                            <div
                                ...
                                <div class="trust-img"><img src="/storage/assets/images/media/landing/web/1.png" alt="img"
                                        ></div>
                                <div class="trust-img"><img src="/storage/assets/images/media/landing/web/2.png" alt="img"
                                        ></div>
                                <div class="trust-img"><img src="/storage/assets/images/media/landing/web/4.png" alt="img"
                                        ></div>
                                <div class="trust-img"><img src="/storage/assets/images/media/landing/web/5.png" alt="img"
                                        ></div>
                                <div class="trust-img"><img src="/storage/assets/images/media/landing/web/6.png" alt="img"
                                        ></div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card custom-card team-member">
                                <div class="card-body text-center p-4">
                                        <span class="avatar avatar-xxl bg-primary-transparent avatar-rounded mb-3 border border-5 border-primary border-opacity-10">
                                            <img src="/storage/assets/images/faces/team/1.png" class="card-img" alt="...">
                                        </span>
                            ...
                            <div class="card custom-card team-member">
                                <div class="card-body text-center p-4">
                                        <span class="avatar avatar-xxl bg-secondary-transparent avatar-rounded mb-3  border border-5 border-secondary border-opacity-10">
                                            <img src="/storage/assets/images/faces/team/2.png" class="card-img" alt="...">
                                        </span>
                                        <div class="text-center py-2">
                            ...
                            <div class="card custom-card team-member">
                                <div class="card-body text-center p-4">
                                        <span class="avatar avatar-xxl bg-success-transparent avatar-rounded mb-3 border border-5 border-success border-opacity-10">
                                            <img src="/storage/assets/images/faces/team/3.png" class="card-img" alt="...">
                                        </span>
                                        <div class="text-center py-2">
                            ...
                            <div class="card custom-card team-member">
                                <div class="card-body text-center p-4">
                                        <span class="avatar avatar-xxl bg-info-transparent avatar-rounded mb-3 border border-5 border-info border-opacity-10">
                                            <img src="/storage/assets/images/faces/team/4.png" class="card-img" alt="...">
                                        </span>
                                        <div class="text-center py-2">
                        ...
                        <div class="col-md-4 col-sm-6 col-12 mb-md-0 mb-3">
                            <div class="px-4">
                                <p class="fw-medium mb-3"><a href="index.html"><img
                                            src="/storage/assets/images/brand-logos/desktop-dark.png" alt=""></a></p>
    ...
    <!-- Choices JS -->
    <script src="/storage/assets/libs/choices.js/public/assets/scripts/choices.min.js"></script>
    ...
    <!-- Internal Landing JS -->
    <script src="/storage/assets/js/landing.js"></script>
