            ...
            <div class="container-fluid">
                ...
                <div class="row">
                                ...
                                <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                                    ...
                                    <div class="carousel-inner rounded-0 p-3 pb-0">
                                        <div class="carousel-item active">
                                            <img src="/storage/assets/images/media/blog/1.jpg" class="d-block w-100 rounded"
                                                alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="/storage/assets/images/media/blog/2.jpg" class="d-block rounded w-100"
                                                alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="/storage/assets/images/media/blog/3.jpg" class="d-block w-100 rounded"
                                                alt="...">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-7">
                                <div class="card custom-card shadow-none">
                                    <div class="row g-0">
                                        ...
                                        <div class="col-sm-4 p-3">
                                            <img src="/storage/assets/images/media/blog/4.jpg"
                                ...
                                <div class="card custom-card shadow-none">
                                    <div class="row g-0">
                                        ...
                                        <div class="col-sm-4 p-3">
                                            <img src="/storage/assets/images/media/blog/5.jpg"
                                                class="img-fluid  rounded h-100 w-100" alt="...">
                                        </div>
                                    </div>
                                </div>
                                <div class="card custom-card shadow-none">
                                    <div class="row g-0">
                                        ...
                                        <div class="col-sm-4 p-3">
                                            <img src="/storage/assets/images/media/blog/6.jpg"
                                                class="img-fluid rounded h-100 w-100" alt="...">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="card custom-card">
                            <a href="javascript:void(0);" class="p-3 pb-0">
                                <img src="/storage/assets/images/media/blog/10.jpg" class="rounded w-100" alt="...">
                            </a>
                            <div class="card-body">
                    ...
                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="card custom-card">
                            <a href="javascript:void(0);" class="p-3 pb-0">
                                <img src="/storage/assets/images/media/blog/11.jpg" class="rounded w-100" alt="...">
                            </a>
                            <div class="card-body">
                    ...
                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="card custom-card">
                            <a href="javascript:void(0);" class="p-3 pb-0">
                                <img src="/storage/assets/images/media/blog/8.jpg" class="rounded w-100" alt="...">
                            </a>
                            <div class="card-body">
                    ...
                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="card custom-card">
                            <a href="javascript:void(0);" class="p-3 pb-0">
                                <img src="/storage/assets/images/media/blog/9.jpg" class="rounded w-100" alt="...">
                            </a>
                            <div class="card-body">
                        ...
                        <div class="row">
                                    ...
                                    <div class="card-body p-0">
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item">
                                                <div class="d-flex flex-wrap align-items-center gap-3">
                                                    <span class="avatar avatar-xl p-1 bg-gray-300">
                                                        <img src="/storage/assets/images/media/blog/14.jpg" class="img-fluid"
                                                            alt="...">
                                                    </span>
                                                    <div class="flex-fill">
                                                        <a href="javascript:void(0);"
                                            ...
                                            <li class="list-group-item">
                                                <div class="d-flex flex-wrap align-items-center gap-3">
                                                    <span class="avatar avatar-xl p-1 bg-gray-300">
                                                        <img src="/storage/assets/images/media/blog/15.jpg" class="img-fluid"
                                                            alt="...">
                                                    </span>
                                                    <div class="flex-fill">
                                                        <a href="javascript:void(0);"
                                            ...
                                            <li class="list-group-item">
                                                <div class="d-flex flex-wrap align-items-center gap-3">
                                                    <span class="avatar avatar-xl p-1 bg-gray-300">
                                                        <img src="/storage/assets/images/media/blog/16.jpg" class="img-fluid"
                                                            alt="...">
                                                    </span>
                                                    <div class="flex-fill">
                                                        <a href="javascript:void(0);"
                                            ...
                                            <li class="list-group-item">
                                                <div class="d-flex flex-wrap align-items-center gap-3">
                                                    <span class="avatar avatar-xl p-1 bg-gray-300">
                                                        <img src="/storage/assets/images/media/blog/17.jpg" class="img-fluid"
                                                            alt="...">
                                                    </span>
                                                    <div class="flex-fill">
                                                        <a href="javascript:void(0);"
                                            ...
                                            <li class="list-group-item border-bottom-0">
                                                <div class="d-flex flex-wrap align-items-center gap-3">
                                                    <span class="avatar avatar-xl p-1 bg-gray-300">
                                                        <img src="/storage/assets/images/media/blog/18.jpg" class="img-fluid"
                                                            alt="...">
                                                    </span>
                                                    <div class="flex-fill">
                                                        <a href="javascript:void(0);"
                            ...
                            <div class="col-xl-6 col-xxl-3 col-lg-12 col-md-12">
                                <div class="card custom-card"> <a href="javascript:void(0);" class="p-3 pb-0 rounded-5">
                                        <img src="/storage/assets/images/media/blog/15.jpg" class="rounded-2 card-img-top"
                                            alt="..."> </a>
                                        ...
                                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                                            <div class="d-flex align-items-center">
                                                <div class="avatar avatar-md avatar-rounded me-2"> <img
                                                        src="/storage/assets/images/faces/11.jpg" alt=""> </div>
                                                <div>
                                ...
                                <div class="card custom-card">
                                    <div class="card-body"> <a href="blog-details.html"
                                        ...
                                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                                            <div class="d-flex align-items-center">
                                                <div class="avatar avatar-md avatar-rounded me-2"> <img
                                                        src="/storage/assets/images/faces/16.jpg" alt=""> </div>
                                                <div>
                                            ...
                                            src="/storage/assets/images/media/blog/20.jpg" class="rounded-2 card-img-bottom"
                                            alt="..."> </a>
                                </div>
                            </div>
                            <div class="col-xl-6 col-xxl-3 col-lg-12 col-md-12">
