...
<body>
                                    ...
                                    <li class="checkforactive">
                                        <a href="javascript:void(0);"
                                            ...
                                            <div class="d-flex align-items-top">
                                                <div class="me-1 lh-1">
                                                    <span class="avatar avatar-md online me-2 avatar-rounded">
                                                        <img src="/storage/assets/images/faces/17.jpg" alt="img">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                                    <p class="mb-0 fw-medium">
                                    ...
                                    <li class="chat-msg-unread checkforactive">
                                        <a href="javascript:void(0);"
                                            ...
                                            <div class="d-flex align-items-top">
                                                <div class="me-1 lh-1">
                                                    <span class="avatar avatar-md online me-2 avatar-rounded">
                                                        <img src="/storage/assets/images/faces/18.jpg" alt="img">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                                    <p class="mb-0 fw-medium">
                                    ...
                                    <li class="chat-inactive checkforactive">
                                        <a href="javascript:void(0);"
                                            ...
                                            <div class="d-flex align-items-top">
                                                <div class="me-1 lh-1">
                                                    <span class="avatar avatar-md offline me-2 avatar-rounded">
                                                        <img src="/storage/assets/images/faces/19.jpg" alt="img">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                                    <p class="mb-0 fw-medium">
                                    ...
                                    <li class="chat-inactive checkforactive">
                                        <a href="javascript:void(0);"
                                            ...
                                            <div class="d-flex align-items-top">
                                                <div class="me-1 lh-1">
                                                    <span class="avatar avatar-md offline me-2 avatar-rounded">
                                                        <img src="/storage/assets/images/faces/20.jpg" alt="img">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                                    <p class="mb-0 fw-medium">
                                    ...
                                    <li class="chat-inactive checkforactive">
                                        <a href="javascript:void(0);"
                                            ...
                                            <div class="d-flex align-items-top">
                                                <div class="me-1 lh-1">
                                                    <span class="avatar avatar-md offline me-2 avatar-rounded">
                                                        <img src="/storage/assets/images/faces/21.jpg" alt="img">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                                    <p class="mb-0 fw-medium">
                        ...
                        <div class="d-flex align-items-center main-chat-head flex-wrap">
                            <div class="me-2 lh-1">
                                <span class="avatar avatar-md online avatar-rounded chatstatusperson">
                                    <img class="chatimageperson" src="/storage/assets/images/faces/8.jpg" alt="img">
                                </span>
                            </div>
                            <div class="flex-fill">
                                    ...
                                    <li class="chat-item-start">
                                        <div class="chat-list-inner">
                                            <div class="chat-user-profile">
                                                <span class="avatar avatar-md online avatar-rounded chatstatusperson">
                                                    <img class="chatimageperson" src="/storage/assets/images/faces/8.jpg"
                                                        alt="img">
                                                </span>
                                            </div>
                                            <div class="ms-3">
                ...
                <div class="chat-user-details" id="chat-user-details">
                    <div class="text-center mb-5">
                        <span class="avatar avatar-rounded online avatar-xxl me-2 mb-3 chatstatusperson">
                            <img class="chatimageperson" src="/storage/assets/images/faces/2.jpg" alt="img">
                        </span>
                    ...
                    <div class="mb-0">
                        ...
                        <div class="row gy-3">
                            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                <a href="/storage/assets/images/media/media-40.jpg" class="glightbox card mb-0"
                                    data-gallery="gallery1">
                                    <img src="/storage/assets/images/media/media-40.jpg" alt="image">
                                </a>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                <a href="/storage/assets/images/media/media-41.jpg" class="glightbox card mb-0"
                                    data-gallery="gallery1">
                                    <img src="/storage/assets/images/media/media-41.jpg" alt="image">
                                </a>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                <a href="/storage/assets/images/media/media-42.jpg" class="glightbox card mb-0"
                                    data-gallery="gallery1">
                                    <img src="/storage/assets/images/media/media-42.jpg" alt="image">
                                </a>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                <a href="/storage/assets/images/media/media-43.jpg" class="glightbox card mb-0"
                                    data-gallery="gallery1">
                                    <img src="/storage/assets/images/media/media-43.jpg" alt="image">
                                </a>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                <a href="/storage/assets/images/media/media-44.jpg" class="glightbox card mb-0"
                                    data-gallery="gallery1">
                                    <img src="/storage/assets/images/media/media-44.jpg" alt="image">
                                </a>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                <a href="/storage/assets/images/media/media-45.jpg" class="glightbox card mb-0"
                                    data-gallery="gallery1">
                                    <img src="/storage/assets/images/media/media-45.jpg" alt="image">
                                </a>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                <a href="/storage/assets/images/media/media-46.jpg" class="glightbox card mb-0"
                                    data-gallery="gallery1">
                                    <img src="/storage/assets/images/media/media-46.jpg" alt="image">
                                </a>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                <a href="/storage/assets/images/media/media-60.jpg" class="glightbox card mb-0"
                                    data-gallery="gallery1">
                                    <img src="/storage/assets/images/media/media-60.jpg" alt="image">
                                </a>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                <a href="/storage/assets/images/media/media-61.jpg" class="glightbox card mb-0"
                                    data-gallery="gallery1">
                                    <img src="/storage/assets/images/media/media-61.jpg" alt="image">
                                </a>
                            </div>
                        </div>
                    </div>
   ...
   @include('zynix.partials.custom_switcherjs')
    ...
    <!-- Emojji Picker JS -->
    <script src="/storage/assets/libs/fg-emoji-picker/fgEmojiPicker.js"></script>
