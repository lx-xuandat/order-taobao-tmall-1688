                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body bd-example-row">
                                            <p class="mb-4">With the move to flexbox in v4, you can use margin utilities like
                                                <span class="text-danger me-1">.me-auto</span>to force sibling columns
                                                away
                                                from one
                                                another.
                                            </p>
                            ...
                            <div class="card custom-card">
                                <div class="card-body">
                                    <P>The classes can be used together with utilities to create responsive floated
                                        ...
                                        is shorter.</P>
                                    <div class="clearfix">
                                        <img src="/storage/assets/images/media/media-40.jpg" class="bd-placeholder-img col-md-6 float-md-end mb-3 ms-md-3 rounded img-fluid" alt="...">
                                        <p>
