                        ...
                        <div class="row">
                            ...
                            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="card custom-card">
                                    <div class="card-body">
                                        <div class="position-relative mb-3 overflow-hidden rounded">
                                            <img src="/storage/assets/images/nft-images/7.jpg" class="card-img rounded" alt="...">
                                            <p class="mb-0 bg-secondary text-fixed-white nft-auction-time"> 04hrs : 24m : 38s </p>
                                            <div class="nft-content">
                                                <a href="javascript:v0id(0);" class="fs-14 fw-bold text-fixed-white">CryptoCanvas</a>
                                                <div class="d-flex mb-0 align-items-center flex-wrap gap-2 justify-content-between">
                            ...
                            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="card custom-card">
                                    <div class="card-body">
                                        <div class="position-relative mb-3 overflow-hidden rounded">
                                            <img src="/storage/assets/images/nft-images/8.jpg" class="card-img rounded" alt="...">
                                            <p class="mb-0 bg-secondary text-fixed-white nft-auction-time"> 04hrs : 24m : 38s </p>
                                            <div class="nft-content">
                                                <a href="javascript:v0id(0);" class="fs-14 fw-bold text-fixed-white">CryptoCanvas</a>
                                                <div class="d-flex mb-0 align-items-center flex-wrap gap-2 justify-content-between">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-md p-1 bg-gray-300 me-2">
                                                                <img src="/storage/assets/images/nft-images/2.jpg" alt="">
                                                            </span>
                                                        </div>
                                            ...
                                            <li class="list-group-item">
                                                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                                    <div class="d-flex align-items-center">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-md p-1 bg-gray-300 me-2">
                                                                <img src="/storage/assets/images/nft-images/18.jpg" alt="">
                                                            </span>
                                                        </div>
                                                        <div class="align-items-center">
                                            ...
                                            <li class="list-group-item">
                                                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                                    <div class="d-flex align-items-center">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-md p-1 bg-gray-300 me-2">
                                                                <img src="/storage/assets/images/nft-images/8.jpg" alt="">
                                                            </span>
                                                        </div>
                                                        <div class="align-items-center">
                                            ...
                                            <li class="list-group-item">
                                                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                                    <div class="d-flex align-items-center">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-md p-1 bg-gray-300  me-2">
                                                                <img src="/storage/assets/images/nft-images/17.jpg" alt="">
                                                            </span>
                                                        </div>
                                                        <div class="align-items-center">
                                            ...
                                            <li class="list-group-item">
                                                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                                    <div class="d-flex align-items-center">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-md p-1 bg-gray-300  me-2">
                                                                <img src="/storage/assets/images/nft-images/31.png" alt="">
                                                            </span>
                                                        </div>
                                                        <div class="align-items-center">
                                        ...
                                        <ul class="list-group list-group-flush">
                                            ...
                                            <li class="list-group-item">
                                                <div class="d-flex gap-3 align-items-center flex-wrap">
                                                    <div class="lh-1">
                                                        <span class="avatar avatar-lg">
                                                            <img src="/storage/assets/images/nft-images/25.png" alt="">
                                                        </span>
                                                    </div>
                                                    <div>
                                            ...
                                            <li class="list-group-item">
                                                <div class="d-flex gap-3 align-items-center flex-wrap">
                                                    <div class="lh-1">
                                                        <span class="avatar avatar-lg">
                                                            <img src="/storage/assets/images/nft-images/21.png" alt="">
                                                        </span>
                                                    </div>
                                                    <div>
                                            ...
                                            <li class="list-group-item">
                                                <div class="d-flex gap-3 align-items-center flex-wrap">
                                                    <div class="lh-1">
                                                        <span class="avatar avatar-lg">
                                                            <img src="/storage/assets/images/nft-images/26.png" alt="">
                                                        </span>
                                                    </div>
                                                    <div>
