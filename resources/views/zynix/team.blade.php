...
<body>
                                ...
                                <div class="card-body text-center p-2">
                                    <div class="mb-4 lh-1 bg-light px-4 py-3">
                                        <span class="avatar avatar-xxl bg-warning-transparent avatar-rounded">
                                            <img src="/storage/assets/images/faces/team/5.png" class="card-img" alt="...">
                                        </span>
                                    </div>
                                    <div class="text-center p-4 pt-0">
                                ...
                                <div class="card-body text-center p-2">
                                    <div class="mb-4 lh-1 bg-light px-4 py-3">
                                        <span class="avatar avatar-xxl bg-danger-transparent avatar-rounded">
                                            <img src="/storage/assets/images/faces/team/6.png" class="card-img" alt="...">
                                        </span>
                                    </div>
                                    <div class="text-center p-4 pt-0">
                                ...
                                <div class="card-body text-center p-2">
                                    <div class="mb-4 lh-1 bg-light px-4 py-3">
                                        <span class="avatar avatar-xxl bg-purple-transparent avatar-rounded">
                                            <img src="/storage/assets/images/faces/team/7.png" class="card-img" alt="...">
                                        </span>
                                    </div>
                                    <div class="text-center p-4 pt-0">
                                ...
                                <div class="card-body text-center p-2">
                                    <div class="mb-4 lh-1 bg-light px-4 py-3">
                                        <span class="avatar avatar-xxl bg-teal-transparent avatar-rounded">
                                            <img src="/storage/assets/images/faces/team/8.png" class="card-img" alt="...">
                                        </span>
                                    </div>
                                    <div class="text-center p-4 pt-0">
   ...
   @include('zynix.partials.custom_switcherjs')
    ...
    <!-- Internal Team JS -->
    <!-- <script src="/storage/assets/js/team.js"></script> -->
