...
<body>
                                                                ...
                                                                <figure class="figure mb-0">
                                                                    <a class="avatar "
                                                                        ...
                                                                        <img class="img-fluid rounded card-img"
                                                                            src="/storage/assets/images/media/media-59.jpg"
                                                                            alt="...">
                                                                    </a>
                                                                </figure>
                                                            </div>
                                                            <div>
                                                                <figure class="figure mb-0">
                                                                    <a class="avatar "
                                                                        href="javascript:void(0);">
                                                                        <img class="img-fluid rounded card-img"
                                                                            src="/storage/assets/images/media/media-60.jpg"
                                                                            alt="...">
                                                                    </a>
                                                                </figure>
                                                            </div>
                                                            <div>
                                                                <figure class="figure mb-0">
                                                                    <a class="avatar "
                                                                        href="javascript:void(0);">
                                                                        <img class="img-fluid rounded card-img"
                                                                            src="/storage/assets/images/media/media-61.jpg"
                                                                            alt="...">
                                                                    </a>
                                                                </figure>
                                                            </div>
                                                            <div>
                                                                <figure class="figure mb-0">
                                                                    <a class="avatar "
                                                                        href="javascript:void(0);">
                                                                        <img class="img-fluid rounded card-img"
                                                                            src="/storage/assets/images/media/media-62.jpg"
                                                                            alt="...">
                                                                    </a>
                                                                </figure>
                                                            </div>
                                    ...
                                    <div class="card-body pb-0">
                                        <div class="d-flex gap-3 mb-3 flex-wrap">
                                             <div class="border p-2 d-flex gap-2 align-items-center rounded">
                                                <span class="avatar avatar-sm">
                                                    <img src="/storage/assets/images/media/media-25.jpg" alt="img">
                                                </span>
                                                <span>Background</span>
                                             </div>
                                             <div class="border p-2 d-flex gap-2 align-items-center rounded">
                                                <span class="avatar avatar-sm">
                                                    <img src="/storage/assets/images/media/media-26.jpg" alt="img">
                                                </span>
                                                <span>Green Nature</span>
                                             </div>
                                             <div class="border p-2 d-flex gap-2 align-items-center rounded">
                                                <span class="avatar avatar-sm">
                                                    <img src="/storage/assets/images/media/media-27.jpg" alt="img">
                                                </span>
                                                <span>Templates</span>
                                             </div>
                                             <div class="border p-2 d-flex gap-2 align-items-center rounded">
                                                <span class="avatar avatar-sm">
                                                    <img src="/storage/assets/images/media/media-28.jpg" alt="img">
                                                </span>
                                                <span>Decoration</span>
                                             </div>
                                             <div class="border p-2 d-flex gap-2 align-items-center rounded">
                                                <span class="avatar avatar-sm">
                                                    <img src="/storage/assets/images/media/media-29.jpg" alt="img">
                                                </span>
                                                <span>Technology</span>
                                             </div>
                                             <div class="border p-2 d-flex gap-2 align-items-center rounded">
                                                <span class="avatar avatar-sm">
                                                    <img src="/storage/assets/images/media/media-30.jpg" alt="img">
                                                </span>
                                                <span>Web Page</span>
                                             </div>
                                             <div class="border p-2 d-flex gap-2 align-items-center rounded">
                                                <span class="avatar avatar-sm">
                                                    <img src="/storage/assets/images/media/media-31.jpg" alt="img">
                                                </span>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                                <a href="/storage/assets/images/media/media-40.jpg"
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                                <a href="/storage/assets/images/media/media-41.jpg"
                                                    class="glightbox card search-images-card" data-gallery="gallery1">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                                <a href="/storage/assets/images/media/media-42.jpg"
                                                    class="glightbox card search-images-card" data-gallery="gallery1">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                                <a href="/storage/assets/images/media/media-43.jpg"
                                                    class="glightbox card search-images-card" data-gallery="gallery1">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                                <a href="/storage/assets/images/media/media-44.jpg"
                                                    class="glightbox card search-images-card" data-gallery="gallery1">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                                <a href="/storage/assets/images/media/media-45.jpg"
                                                    class="glightbox card search-images-card" data-gallery="gallery1">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                                <a href="/storage/assets/images/media/media-46.jpg"
                                                    class="glightbox card search-images-card" data-gallery="gallery1">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                                <a href="/storage/assets/images/media/media-60.jpg"
                                                    class="glightbox card search-images-card" data-gallery="gallery1">
                                                    <img src="/storage/assets/images/media/media-60.jpg" alt="image">
                                                    <div class="p-3 text-center">
                                                        <div class="d-flex align-items-center justify-content-center gap-1">
                                                            <div class="avatar avatar-sm bg-light border avatar-rounded">
                                                                <img src="/storage/assets/images/company-logos/6.png" alt="">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <div>
                                                                    <span
                                                                        ...
                                                                        <img src="/storage/assets/images/media/books/6.jpg"
                                                                            alt="">
                                                                    </span>
                                                                </div>
                                                                <div class="ms-2">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <div>
                                                                    <span
                                                                        class="avatar avatar-lg avatar-rounded bg-primary bg-opacity-10 border">
                                                                        <img src="/storage/assets/images/media/books/1.jpg"
                                                                            alt="">
                                                                    </span>
                                                                </div>
                                                                <div class="ms-2">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <div>
                                                                    <span
                                                                        class="avatar avatar-lg avatar-rounded bg-primary bg-opacity-10 border">
                                                                        <img src="/storage/assets/images/media/books/2.jpg"
                                                                            alt="">
                                                                    </span>
                                                                </div>
                                                                <div class="ms-2">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <div>
                                                                    <span
                                                                        class="avatar avatar-lg avatar-rounded bg-primary bg-opacity-10 border">
                                                                        <img src="/storage/assets/images/media/books/3.jpg"
                                                                            alt="">
                                                                    </span>
                                                                </div>
                                                                <div class="ms-2">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <div>
                                                                    <span
                                                                        class="avatar avatar-lg avatar-rounded bg-primary bg-opacity-10 border">
                                                                        <img src="/storage/assets/images/media/books/4.jpg"
                                                                            alt="">
                                                                    </span>
                                                                </div>
                                                                <div class="ms-2">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <div>
                                                                    <span
                                                                        class="avatar avatar-lg avatar-rounded bg-primary bg-opacity-10 border">
                                                                        <img src="/storage/assets/images/media/books/5.jpg"
                                                                            alt="">
                                                                    </span>
                                                                </div>
                                                                <div class="ms-2">
                                ...
                                <div class="row">
                                        ...
                                        <div class="card custom-card">
                                           <div class="card-body">
                                            <div class="d-flex gap-3 align-items-center flex-wrap">
                                                <span class="avatar avatar-xxl"><img src="/storage/assets/images/media/media-26.jpg" alt="img"></span>
                                                <div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="card custom-card">
                                           <div class="card-body">
                                            <div class="d-flex gap-3 align-items-center flex-wrap">
                                                <span class="avatar avatar-xxl"><img src="/storage/assets/images/media/media-27.jpg" alt="img"></span>
                                                <div>
                                                    <a href="javascript:void(0);" class="stretched-link"></a>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="card custom-card">
                                           <div class="card-body">
                                            <div class="d-flex gap-3 align-items-center flex-wrap">
                                                <span class="avatar avatar-xxl"><img src="/storage/assets/images/media/media-28.jpg" alt="img"></span>
                                                <div>
                                                    <a href="javascript:void(0);" class="stretched-link"></a>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="card custom-card">
                                           <div class="card-body">
                                            <div class="d-flex gap-3 align-items-center flex-wrap">
                                                <span class="avatar avatar-xxl"><img src="/storage/assets/images/media/media-29.jpg" alt="img"></span>
                                                <div>
                                                    <a href="javascript:void(0);" class="stretched-link"></a>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="card custom-card">
                                           <div class="card-body">
                                            <div class="d-flex gap-3 align-items-center flex-wrap">
                                                <span class="avatar avatar-xxl"><img src="/storage/assets/images/media/media-30.jpg" alt="img"></span>
                                                <div>
                                                    <a href="javascript:void(0);" class="stretched-link"></a>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="card custom-card">
                                           <div class="card-body">
                                            <div class="d-flex gap-3 align-items-center flex-wrap">
                                                <span class="avatar avatar-xxl"><img src="/storage/assets/images/media/media-31.jpg" alt="img"></span>
                                                <div>
                                                    <a href="javascript:void(0);" class="stretched-link"></a>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="card custom-card">
                                           <div class="card-body">
                                            <div class="d-flex gap-3 align-items-center flex-wrap">
                                                <span class="avatar avatar-xxl"><img src="/storage/assets/images/media/media-32.jpg" alt="img"></span>
                                                <div>
                                                    <a href="javascript:void(0);" class="stretched-link"></a>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="card custom-card">
                                           <div class="card-body">
                                            <div class="d-flex gap-3 align-items-center flex-wrap">
                                                <span class="avatar avatar-xxl"><img src="/storage/assets/images/media/media-33.jpg" alt="img"></span>
                                                <div>
                                                    <a href="javascript:void(0);" class="stretched-link"></a>
   ...
   @include('zynix.partials.custom_switcherjs')
    ...
    <script src="/storage/assets/js/search-results.js"></script>
