...
<body>
                        ...
                        <div class="col-xl-12">
                            <div class="card custom-card job-profile-card">
                                <div class="profile-banner-img">
                                    <img src="/storage/assets/images/media/media-75.jpg" class="rounded w-100" alt="...">
                                </div>
                                <div class="card-body p-4 pb-0 position-relative">
                                        <span class="avatar avatar-xxl avatar-rounded bg-light">
                                            <img src="/storage/assets/images/faces/team/5.png" class="rounded-circle img-fluid" alt="img">
                                        </span>
                                            ...
                                            <div class="card-body">
                                                <div class="p-3 bg-light border border-bottom-0">
                                                    ...
                                                    <div class="d-flex align-items-center flex-wrap gap-2">
                                                        <div>
                                                            <span class="avatar avatar-lg avatar-rounded">
                                                                <img src="/storage/assets/images/faces/21.jpg" alt="">
                                                            </span>
                                                        </div>
                                                        <div>
   ...
   @include('zynix.partials.commonjs')
    ...
    <script src="/storage/assets/js/job-candidate-details.js"></script>
