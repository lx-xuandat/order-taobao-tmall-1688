                                    ...
                                    <nav class="navbar navbar-expand-lg bg-light">
                                        <div class="container-fluid">
                                            <a aria-label="anchor" class="navbar-brand" href="javascript:void(0);">
                                                <img src="/storage/assets/images/brand-logos/toggle-logo.png" alt="" class="d-inline-block align-text-top">
                                            </a>
                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <nav class="navbar bg-light mb-3">
                                        <div class="container-fluid">
                                            <a aria-label="anchor" class="navbar-brand" href="javascript:void(0);"><img src="/storage/assets/images/brand-logos/toggle-logo.png" alt=""></a>
                                        </div>
                                    </nav>
                                    <nav class="navbar bg-light">
                                        <div class="container-fluid">
                                            <span class="navbar-brand mb-0 h1"><img src="/storage/assets/images/brand-logos/toggle-logo.png" alt=""></span>
                                        </div>
                                    </nav>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-12">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <nav class="navbar bg-light mb-3">
                                        <div class="container-fluid">
                                            <a aria-label="anchor" class="navbar-brand"><img src="/storage/assets/images/brand-logos/toggle-logo.png" alt=""></a>
                                            <form class="d-flex" role="search">
                                                <input class="form-control me-2" type="search" placeholder="Search"
                                                    aria-label="Search">
                                                <button class="btn btn-primary" type="submit">Search</button>
                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <nav class="navbar navbar-expand-lg navbar-primary-transparent mb-3">
                                        <div class="container-fluid">
                                            <a aria-label="anchor" class="navbar-brand" href="javascript:void(0);">
                                                <img src="/storage/assets/images/brand-logos/toggle-logo.png" alt="">
                                            </a>
                                            <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <nav class="navbar navbar-expand-lg navbar-primary mb-3">
                                        <div class="container-fluid">
                                            <a aria-label="anchor" class="navbar-brand" href="javascript:void(0);">
                                                <img src="/storage/assets/images/brand-logos/toggle-dark.png" alt="">
                                            </a>
                                            <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
                                    ...
                                    <nav class="navbar navbar-expand-lg navbar-secondary mb-3">
                                        <div class="container-fluid">
                                            <a aria-label="anchor" class="navbar-brand" href="javascript:void(0);"><img src="/storage/assets/images/brand-logos/toggle-dark.png" alt=""></a>
                                            <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
